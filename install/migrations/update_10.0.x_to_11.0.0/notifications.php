...
$notification_exists = countElementsInTable('zentra_notifications', ['itemtype' => 'User', 'event' => 'passwordinit']) > 0;
...
if (countElementsInTable('zentra_notifications', ['itemtype' => 'Change', 'event' => 'satisfaction']) === 0) {
    $DB->insert(
        'zentra_notificationtemplates',
        [
...
if (countElementsInTable('zentra_notifications', ['itemtype' => 'Ticket', 'event' => 'auto_reminder']) === 0) {
    $DB->insert('zentra_notificationtemplates', [
    ...
    $DB->insert('zentra_notificationtemplatetranslations', [
        'notificationtemplates_id' => $notificationtemplate_id,
        'language' => '',
...
$migration->addField("zentra_notifications", "attach_documents", "tinyint NOT NULL DEFAULT '-2'");
...
$migration->addField("zentra_queuednotifications", "itemtype_trigger", "varchar(255) DEFAULT NULL");
$migration->addField("zentra_queuednotifications", "items_id_trigger", "fkey");
$migration->addKey(
    "zentra_queuednotifications",
...
$migration->addField('zentra_notificationtargets', 'is_exclusion', 'boolean');
$migration->addKey('zentra_notificationtargets', ['is_exclusion'], 'is_exclusion');
