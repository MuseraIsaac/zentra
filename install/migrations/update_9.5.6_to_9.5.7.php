...
function update956to957()
{
    ...
    $itil_tables = ['zentra_changes', 'zentra_problems', 'zentra_tickets'];
    ...
    /** Replace -1 values for zentra_networkportaliases.networkports_id_alias field */
    $migration->addPostQuery(
        $DB->buildUpdate(
    ...
    /** Fix unicity in zentra_items_operatingsystems table */
    ...
    foreach ($data as $row) {
        $delete = $DB->buildDelete('zentra_items_operatingsystems', [
            'operatingsystems_id' => [-1, 0],
