...
### Dump table zentra_itemantiviruses

DROP TABLE IF EXISTS `zentra_itemantiviruses`;
CREATE TABLE `zentra_itemantiviruses` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
### Previously zentra_computers_items < 11.0.0
### Dump table zentra_assets_assets_peripheralassets

DROP TABLE IF EXISTS `zentra_assets_assets_peripheralassets`;
CREATE TABLE `zentra_assets_assets_peripheralassets` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
### Dump table zentra_itemvirtualmachines

DROP TABLE IF EXISTS `zentra_itemvirtualmachines`;
CREATE TABLE `zentra_itemvirtualmachines` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `entities_id` int unsigned NOT NULL DEFAULT '0',
  `itemtype` varchar(255) DEFAULT NULL,
  `items_id` int unsigned NOT NULL DEFAULT '0',
...
### Dump table zentra_deviceharddrivetypes

DROP TABLE IF EXISTS `zentra_deviceharddrivetypes`;
CREATE TABLE `zentra_deviceharddrivetypes` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `comment` text,
  PRIMARY KEY (`id`),
...
### Dump table zentra_helpdesks_tiles_profiles_tiles

DROP TABLE IF EXISTS `zentra_helpdesks_tiles_items_tiles`;
...
### Dump table zentra_helpdesks_tiles_formtiles

DROP TABLE IF EXISTS `zentra_helpdesks_tiles_formtiles`;
...
### Dump table zentra_helpdesks_tiles_zentrapagetiles

DROP TABLE IF EXISTS `zentra_helpdesks_tiles_zentrapagetiles`;
...
### Dump table zentra_helpdesks_tiles_externalpagetiles

DROP TABLE IF EXISTS `zentra_helpdesks_tiles_externalpagetiles`;
...
### Dump table zentra_items_processes

DROP TABLE IF EXISTS `zentra_items_processes`;
CREATE TABLE `zentra_items_processes` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `itemtype` varchar(100) DEFAULT NULL,
  `items_id` int unsigned NOT NULL DEFAULT '0',
  `cmd` text,
...
### Dump table zentra_items_environments

DROP TABLE IF EXISTS `zentra_items_environments`;
CREATE TABLE `zentra_items_environments` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `itemtype` varchar(100) DEFAULT NULL,
  `items_id` int unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS zentra_dropdownvisibilities;
CREATE TABLE `zentra_dropdownvisibilities` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `itemtype` varchar(100) NOT NULL DEFAULT '',
  `items_id` int unsigned NOT NULL DEFAULT '0',
...
### Dump table zentra_tickettemplatereadonlyfields

DROP TABLE IF EXISTS `zentra_tickettemplatereadonlyfields`;
CREATE TABLE `zentra_tickettemplatereadonlyfields` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `tickettemplates_id` int unsigned NOT NULL DEFAULT '0',
  `num` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
### Dump table zentra_changeemplatereadonlyfields

DROP TABLE IF EXISTS `zentra_changetemplatereadonlyfields`;
CREATE TABLE `zentra_changetemplatereadonlyfields` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `changetemplates_id` int unsigned NOT NULL DEFAULT '0',
  `num` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
### Dump table zentra_problemtemplatereadonlyfields

DROP TABLE IF EXISTS `zentra_problemtemplatereadonlyfields`;
CREATE TABLE `zentra_problemtemplatereadonlyfields` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `problemtemplates_id` int unsigned NOT NULL DEFAULT '0',
  `num` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
### Dump table zentra_validationsteps - used by ValidationStep Dropdown

DROP TABLE IF EXISTS `zentra_validationsteps`;
CREATE TABLE `zentra_validationsteps` (
    `id`                                  int unsigned          NOT NULL    AUTO_INCREMENT,
    `name`                                varchar(255)                      DEFAULT NULL,
...
### Dump table zentra_itils_validationsteps - used by ValidationStep Dropdown

DROP TABLE IF EXISTS `zentra_itils_validationsteps`;
CREATE TABLE `zentra_itils_validationsteps` (
    `id`                                    int unsigned        NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `zentra_items_plugs`;
CREATE TABLE `zentra_items_plugs` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `zentra_forms_categories`;
...
DROP TABLE IF EXISTS `zentra_forms_forms`;
...
DROP TABLE IF EXISTS `zentra_forms_sections`;
...
DROP TABLE IF EXISTS `zentra_forms_questions`;
...
DROP TABLE IF EXISTS `zentra_forms_comments`;
...
DROP TABLE IF EXISTS `zentra_forms_answerssets`;
...
DROP TABLE IF EXISTS `zentra_forms_destinations_answerssets_formdestinationitems`;
...
DROP TABLE IF EXISTS `zentra_forms_destinations_formdestinations`;
...
DROP TABLE IF EXISTS `zentra_forms_accesscontrols_formaccesscontrols`;
...
DROP TABLE IF EXISTS `zentra_items_ticketrecurrents`;
CREATE TABLE `zentra_items_ticketrecurrents` (
   `id` int unsigned NOT NULL AUTO_INCREMENT,
   `itemtype` varchar(255) DEFAULT NULL,
   `items_id` int unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `zentra_items_lines`;
CREATE TABLE `zentra_items_lines` (
   `id` int unsigned NOT NULL AUTO_INCREMENT,
   `lines_id` int unsigned NOT NULL DEFAULT '0',
   `itemtype` varchar(100) DEFAULT NULL,
   `items_id` int unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `zentra_changes_changes`;
CREATE TABLE `zentra_changes_changes` (
   `id` int unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `zentra_problems_problems`;
CREATE TABLE `zentra_problems_problems` (
   `id` int unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `zentra_changesatisfactions`;
CREATE TABLE `zentra_changesatisfactions` (
   `id` int unsigned NOT NULL AUTO_INCREMENT,
   `changes_id` int unsigned NOT NULL DEFAULT '0',
   `type` int NOT NULL DEFAULT '1',
   `date_begin` timestamp NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `zentra_oauth_access_tokens`;
CREATE TABLE `zentra_oauth_access_tokens` (
...
DROP TABLE IF EXISTS `zentra_oauth_refresh_tokens`;
CREATE TABLE `zentra_oauth_refresh_tokens` (
   `identifier` varchar(255) NOT NULL,
...
DROP TABLE IF EXISTS `zentra_oauth_auth_codes`;
CREATE TABLE `zentra_oauth_auth_codes` (
   `identifier` varchar(255) NOT NULL,
   `client` varchar(255) NOT NULL,
   `date_expiration` timestamp NOT NULL,
   `user_identifier` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `zentra_oauthclients`;
CREATE TABLE `zentra_oauthclients` (
   `identifier` varchar(255) NOT NULL,
   `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Internal ZENTRA ID',
   `name` varchar(255) NOT NULL DEFAULT '',
...
DROP TABLE IF EXISTS `zentra_validatorsubstitutes`;
CREATE TABLE `zentra_validatorsubstitutes` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `zentra_searches_criteriafilters`;
CREATE TABLE `zentra_searches_criteriafilters` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `itemtype` varchar(100) DEFAULT NULL,
  `items_id` int unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `zentra_itilvalidationtemplates`;
CREATE TABLE `zentra_itilvalidationtemplates` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `entities_id` int unsigned NOT NULL DEFAULT '0',
  `is_recursive` tinyint NOT NULL DEFAULT '0',
  `validationsteps_id` int unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `zentra_itilvalidationtemplates_targets`;
CREATE TABLE `zentra_itilvalidationtemplates_targets` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `itilvalidationtemplates_id` int unsigned NOT NULL DEFAULT '0',
  `itemtype` varchar(100) DEFAULT NULL,
  `items_id` int unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `zentra_itilreminders`;
CREATE TABLE `zentra_itilreminders` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `itemtype` varchar(100) NOT NULL,
  `items_id` int unsigned NOT NULL DEFAULT '0',
  `pendingreasons_id` int unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `zentra_defaultfilters`;
CREATE TABLE `zentra_defaultfilters` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `is_active` tinyint NOT NULL DEFAULT '1',
  `comment` text DEFAULT NULL,
...
DROP TABLE IF EXISTS `zentra_webhooks`;
CREATE TABLE `zentra_webhooks` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `entities_id` int unsigned NOT NULL DEFAULT '0',
  `is_recursive` tinyint NOT NULL DEFAULT '0',
  `name` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `zentra_webhookcategories`;
CREATE TABLE `zentra_webhookcategories` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL,
  `comment` text,
  `webhookcategories_id` int unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `zentra_queuedwebhooks`;
CREATE TABLE `zentra_queuedwebhooks` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `itemtype` varchar(100) DEFAULT NULL,
  `items_id` int unsigned NOT NULL DEFAULT '0',
  `entities_id` int unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `zentra_stencils`;
CREATE TABLE `zentra_stencils` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `itemtype` varchar(100) NOT NULL,
  `items_id` int unsigned NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `zentra_assets_assetdefinitions`;
...
DROP TABLE IF EXISTS `zentra_assets_assets`;
...
DROP TABLE IF EXISTS `zentra_assets_assetmodels`;
...
DROP TABLE IF EXISTS `zentra_assets_assettypes`;
...
DROP TABLE IF EXISTS `zentra_groups_items`;
...
DROP TABLE IF EXISTS `zentra_dropdowns_dropdowndefinitions`;
...
DROP TABLE IF EXISTS `zentra_dropdowns_dropdowns`;
...
DROP TABLE IF EXISTS `zentra_assets_customfielddefinitions`;
...
DROP TABLE IF EXISTS `zentra_contracts_users`;
CREATE TABLE `zentra_contracts_users` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `contracts_id` int unsigned NOT NULL DEFAULT '0',
  `users_id` int unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `zentra_softwarelicenses_users`;
CREATE TABLE `zentra_softwarelicenses_users` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `softwarelicenses_id` int unsigned NOT NULL DEFAULT '0',
  `users_id` int unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `zentra_itemtranslations_itemtranslations`;
CREATE TABLE `zentra_itemtranslations_itemtranslations` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `items_id` int unsigned NOT NULL DEFAULT '0',
  `itemtype` varchar(100) NOT NULL,
