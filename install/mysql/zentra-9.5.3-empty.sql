...
CREATE TABLE IF NOT EXISTS `zentra_appliances_items` (
   `id` int(11) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `zentra_appliancetypes` (
   `id` int(11) NOT NULL auto_increment,
   `entities_id` int(11) NOT NULL DEFAULT '0',
   `is_recursive` tinyint(1) NOT NULL DEFAULT '0',
   `name` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `zentra_applianceenvironments` (
   `id` int(11) NOT NULL auto_increment,
   `name` varchar(255) DEFAULT NULL,
   `comment` text,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `zentra_appliances_items_relations` (
   `id` int(11) NOT NULL auto_increment,
