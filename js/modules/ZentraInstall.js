...
{
    const messages_container = document.getElementById('zentra_install_messages_container');
    const success_container = document.getElementById('zentra_install_success');
    const back_button_container = document.getElementById('zentra_install_back');

    const request = new Request(
        `${CFG_ZENTRA.root_doc}/Install/InitDatabase`,
        {
            method: 'POST',
            headers: {
...
{
    const messages_container = document.getElementById('zentra_update_messages_container');
    const success_container = document.getElementById('zentra_update_success');

    const request = new Request(
        `${CFG_ZENTRA.root_doc}/Install/UpdateDatabase`,
        {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
