 ...
 */
var zentra_html_dialog = function({
    title       = "",
    body        = "",
    footer      = "",
    modalclass  = "",
 ...
 * @param {boolean} dialog.bs_focus - Data-bs-focus value for the modal
 */
var zentra_ajax_dialog = function({
    url         = "",
    params      = {},
    method      = 'post',
    title       = "",
...
/**
 * Remove from dom all opened zentra dialog
 */
var zentra_close_all_dialogs = function() {
 ...
 */
const zentra_toast = (title, message, css_class, options = {}) => {
    toast_id++;
    ...
    let location = CFG_ZENTRA.toast_location || 'bottom-right';
 ...
 * @param {ToastOptions} options Toast options
 */
const zentra_toast_success = (message, caption = undefined, options = {}) => {
    zentra_toast(caption || __('Success'), message, 'bg-success text-white border-0', options);
};
 ...
 * @param {ToastOptions} options Toast options
 */
const zentra_toast_info = function(message, caption = undefined, options = {}) {
    zentra_toast(caption || _n("Information", "Information", 1), message, 'bg-info text-white border-0', options);
};
 ...
 * @param {ToastOptions} options Toast options
 */
const zentra_toast_warning = (message, caption = undefined, options = {}) => {
    zentra_toast(caption || __('Warning'), message, 'bg-warning text-white border-0', options);
};
 ...
 * @param {ToastOptions} options Toast options
 */
const zentra_toast_error = (message, caption = undefined, options = {}) => {
    zentra_toast(caption || _n('Error', 'Errors', 1), message, 'bg-danger text-white border-0', options);
};
