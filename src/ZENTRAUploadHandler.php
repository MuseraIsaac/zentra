...
/** ZENTRAUploadHandler class
 *
 * @since 9.2
 **/
class ZENTRAUploadHandler extends UploadHandler
{
    /**
     * @param array $params
     *
    ...
    {
        if (
            !empty(ZENTRA_DISALLOWED_UPLOADS_PATTERN)
            && preg_match(ZENTRA_DISALLOWED_UPLOADS_PATTERN, $file->name) === 1
        ) {
