...
namespace Zentra\Agent\Communication;
 ...
 *
 * @see https://github.com/zentra-project/inventory_format/blob/master/inventory.schema.json
 */
abstract class AbstractRequest
{
    ...
    public function handleRequest(mixed $data): bool
    {
        ...
        if ($auth_required === Conf::BASIC_AUTH) {
            ...
            if (is_null($authorization_header)) {
                ...
                if (preg_match('/^Basic\s+(.*)$/i', $authorization_header, $matches)) {
                    ...
                    $inventory_password = (new ZENTRAKey())
        ...
        // and ZENTRA will consume about 500MB of memory to handle it,
    ...
    /**
     * Handle ZENTRA framework messages
     *
     * @return void
     */
