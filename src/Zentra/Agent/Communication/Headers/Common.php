...
namespace Zentra\Agent\Communication\Headers;
...
class Common
{
    ...
    //ZENTRA agent headers
    /**
     * "ZENTRA-Agent-ID" HTTP header
     * Required
     *
     ...
     * @var string
     */
    protected string $zentra_agent_id;

    /**
     * "ZENTRA-Request-ID" HTTP header
     *
     * 8 digit hexadecimal string in higher case like 2E6A9AF1
     *
     * @var string
     */
    protected string $zentra_request_id;

    /**
     * "ZENTRA-CryptoKey-ID" HTTP header
     *
     * List of agentid separated by commas
     *
     * @var string
     */
    protected string $zentra_cryptokey_id;

    /**
     * "ZENTRA-Proxy-ID" HTTP header
     *
     * List of agentid separated by commas
     *
     * @var string
     */
    protected string $zentra_proxy_id;
    ...
    {
        return [
            'zentra_cryptokey_id' => 'ZENTRA-CryptoKey-ID',
        ];
    }
