...
use Zentra\Api\HL\OpenAPIGenerator;
...
EOT,
    ...
    public function showDocumentation(Request $request): Response
    {
        ...
        $swagger_content = '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>ZENTRA API Documentation</title>';
        ...
        $doc_json_path = $CFG_ZENTRA['root_doc'] . '/api.php/v' . $api_version . '/doc.json';
        ...
        <body>
            ...
            <script>
                const ui = window.SwaggerUIBundle({
                    ...
                    filter: true,
                    showExtensions: true,
                    oauth2RedirectUrl: '{$CFG_ZENTRA['root_doc']}/api.php/swagger-oauth-redirect',
...
HTML;
    ...
    {
        $documentation_file = ZENTRA_ROOT . '/resources/api_doc.MD';
    ...
    public function defaultOptionsRoute(Request $request): Response
    {
        ...
        if (isset($_SERVER['HTTP_ACCESS_CONTROL_REQUEST_HEADERS'])) {
            $response_headers['Access-Control-Allow-Headers'] = [
                ...
                'ZENTRA-API-Version', 'ZENTRA-Profile', 'ZENTRA-Entity', 'ZENTRA-Entity-Recursive',
                'X-Debug-Mode',
            ];
    ...
    public function getSession(Request $request): Response
    {
        ...
        $active_profile = $_SESSION['zentraactiveprofile'];
        ...
        $session['active_entity'] = [
            ...
            'short_name' => $_SESSION['zentraactive_entity_shortname'],
            'complete_name' => $_SESSION['zentraactive_entity_name'],
            'recursive' => $_SESSION['zentraactive_entity_recursive'],
        ];
    ...
    public function authorize(Request $request): Response
    {
        ...
        try {
            ...
            if ($user_id === false) {
                ...
                $redirect_uri = $CFG_ZENTRA['url_base']
                    . '/api.php/v2'
                    . $this->getAPIPathForRouteFunction(self::class, 'authorize')
                    . '?'
                    . http_build_query($redirect_params);
                return new Response(302, ['Location' => $CFG_ZENTRA['url_base'] . '/?redirect=' . rawurlencode($redirect_uri)]);
            }
            $user = new \Zentra\OAuth\User();
    ...
    {
        $content = file_get_contents(ZENTRA_ROOT . '/public/lib/swagger-ui-dist/oauth2-redirect.html');
        return new Response(200, ['Content-Type' => 'text/html'], $content);
    }

    #[Route(path: '/status', methods: ['GET'], tags: ['Status'], scopes: ['status'])]
    #[RouteVersion(introduced: '2.0')]
    #[Doc\Route(description: 'Get a list of all ZENTRA system status checker services.')]
    ...
    #[RouteVersion(introduced: '2.0')]
    #[Doc\Route(
        description: 'Get the the status of all ZENTRA system status checker services',
        responses: [
            new Doc\Response(
    ...
    #[RouteVersion(introduced: '2.0')]
    #[Doc\Route(
        description: 'Get the status of a ZENTRA system status checker service. Use "all" as the service to get the full system status.',
        responses: [
            new Doc\Response(
                schema: new Doc\Schema(
                    type: Doc\Schema::TYPE_OBJECT,
