                ...
                'read' => static function () use ($itil_type) {
                    ...
                    if ($itil_type !== Ticket::class) {
                        if (Session::haveRight($itil_type::$rightname, CommonITILObject::READMY)) {
                            ...
                            if (!empty($_SESSION['zentragroups'])) {
                                ...
                                $criteria['WHERE']['OR'][$group_table . '.groups_id'] = $_SESSION['zentragroups'];
                            }
                            return $criteria;
                        }
                    } else {
                        ...
                        $criteria = [
                            'LEFT JOIN' => [
                                'zentra_tickets_users' => [
                                    'ON' => [
                                        'zentra_tickets_users' => Ticket::getForeignKeyField(),
                                        '_' => 'id',
                                    ],
                                ],
                                'zentra_groups_tickets' => [
                                    'ON' => [
                                        'zentra_groups_tickets' => Ticket::getForeignKeyField(),
                                        '_' => 'id',
                                    ],
                                ],
                            ],
                        ...
                        if (Session::haveRight(Ticket::$rightname, CommonITILObject::READMY)) {
                            ...
                            $criteria['WHERE']['OR'][] = [
                                'AND' => [
                                    ...
                                    'zentra_tickets_users' . '.type' => [CommonITILActor::REQUESTER, CommonITILActor::OBSERVER],
                                ],
                            ];
                        }
                        if (!empty($_SESSION['zentragroups']) && Session::haveRight(Ticket::$rightname, Ticket::READGROUP)) {
                            // Permission to see tickets as requester or observer group member
                            $criteria['WHERE']['OR'][] = [
                                'AND' => [
                                    'zentra_groups_tickets.groups_id' => $_SESSION['zentragroups'],
                                    'zentra_groups_tickets.type' => [CommonITILActor::REQUESTER, CommonITILActor::OBSERVER],
                                ],
                            ];
                        }
