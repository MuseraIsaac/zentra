                    ...
                    'read' => static function () {
                        if (!Session::haveRight(Project::$rightname, Project::READALL)) {
                            ...
                            $criteria = [
                                ...
                                'WHERE' => [
                                    'OR' => [
                                        ...
                                        [
                                            "zentra_projectteams.itemtype"   => 'User',
                                            "zentra_projectteams.items_id"   => Session::getLoginUserID(),
                                        ],
                                    ],
                                ],
                            ];
                            if (count($_SESSION['zentragroups'])) {
                                $criteria['WHERE']['OR'][] = [
                                    '_.groups_id' => $_SESSION['zentragroups'],
                                ];
                                $criteria['WHERE']['OR'][] = [
                                    "zentra_projectteams.itemtype"   => 'Group',
                                    "zentra_projectteams.items_id"   => $_SESSION['zentragroups'],
                                ];
                            }
                            return $criteria;
                        }
                        ...
                        if (!Session::haveRight(Project::$rightname, Project::READALL)) {
                            ...
                            if (count($_SESSION['zentragroups'])) {
                                $project_criteria['WHERE']['OR'][] = [
                                    'project.groups_id' => $_SESSION['zentragroups'],
                                ];
                                $project_criteria['WHERE']['OR'][] = [
                                    "zentra_projectteams.itemtype"   => 'Group',
                                    "zentra_projectteams.items_id"   => $_SESSION['zentragroups'],
                            ...
                            $criteria = [
                                ...
                                'WHERE' => [
                                    'OR' => [
                                        ...
                                        [
                                            'zentra_projecttaskteams.items_id' => Session::getLoginUserID(),
                            ...
                            if (count($_SESSION['zentragroups'])) {
                                $criteria['WHERE']['OR'][] = [
                                    'zentra_projecttaskteams.items_id' => $_SESSION['zentragroups'],
                                    'zentra_projecttaskteams.itemtype' => 'Group',
                                ];
                            }
                            return $criteria;
                        }
