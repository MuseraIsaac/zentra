...
class Schema implements ArrayAccess
{
    ...
    /**
     * Combine schemas related to multiple ZENTRA itemtypes into a single 'union' schema that allows searching across all of them
     * @param non-empty-array<string, class-string<CommonZENTRA>> $itemtypes
     * @return array{x-subtypes: list<array{schema_name: string, itemtype: string}>, type: self::TYPE_OBJECT, properties: array}
     * @see getUnionSchema
     */
