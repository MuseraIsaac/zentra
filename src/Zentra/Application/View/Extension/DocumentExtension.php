...
class DocumentExtension extends AbstractExtension
{
    ...
    public function getDocumentIcon(string $filename): string
    {
        ...
        return $CFG_ZENTRA['root_doc'] . (file_exists(ZENTRA_ROOT . $icon) ? $icon : $defaultIcon);
    }

    /**
     * Returns human readable size of file matching given path (relative to ZENTRA_DOC_DIR).
     *
    ...
    {
        $fullpath = ZENTRA_DOC_DIR . '/' . $filepath;
