...
class ItemtypeExtension extends AbstractExtension
{
     ...
     *
     * @return CommonZENTRA|null
     */
    public function getItemtypeClass(string $itemtype): ?CommonZENTRA
    {
        return is_a($itemtype, CommonZENTRA::class, true) ? new $itemtype() : null;
    }
    ...
    {
        return is_a($itemtype, CommonZENTRA::class, true) ? $itemtype::getTypeName($count) : null;
    }
    ...
    {
        return is_a($itemtype, CommonZENTRA::class, true) ? $itemtype::getSearchURL() : null;
    }
