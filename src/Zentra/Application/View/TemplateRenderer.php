...
namespace Zentra\Application\View;

use Zentra\Application\Environment as ZENTRAEnvironment;
use Zentra\Application\View\Extension\ConfigExtension;
use Zentra\Application\View\Extension\DataHelpersExtension;
use Zentra\Application\View\Extension\DocumentExtension;
use Zentra\Application\View\Extension\FrontEndAssetsExtension;
use Zentra\Application\View\Extension\HtmlExtension;
use Zentra\Application\View\Extension\I18nExtension;
use Zentra\Application\View\Extension\IllustrationExtension;
use Zentra\Application\View\Extension\ItemtypeExtension;
use Zentra\Application\View\Extension\PhpExtension;
use Zentra\Application\View\Extension\PluginExtension;
use Zentra\Application\View\Extension\RoutingExtension;
use Zentra\Application\View\Extension\SearchExtension;
use Zentra\Application\View\Extension\SecurityExtension;
use Zentra\Application\View\Extension\SessionExtension;
use Zentra\Application\View\Extension\TeamExtension;
...
class TemplateRenderer
{
    ...
    public function __construct(string $rootdir = ZENTRA_ROOT, ?string $cachedir = null)
    {
        if ($cachedir === null) {
        ...
        $zentra_environment = ZENTRAEnvironment::get();
        $env_params = [
            'debug' => $zentra_environment->shouldEnableExtraDevAndDebugTools() || ($_SESSION['zentra_use_mode'] ?? null) === Session::DEBUG_MODE,
            'auto_reload' => $zentra_environment->shouldExpectResourcesToChange(),
            'strict_variables' => ZENTRA_STRICT_ENV,
        ];
