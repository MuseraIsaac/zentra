...
final class Asset_PeripheralAsset extends CommonDBRelation
{
    ...
    public static function getRelationMassiveActionsSpecificities()
    {
        ...
        $specificities['itemtypes'] = $CFG_ZENTRA['directconnect_types'];
        $specificities['select_items_options_1']['itemtypes']       = self::getPeripheralHostItemtypes();
        $specificities['select_items_options_2']['entity_restrict'] = $_SESSION['zentraactive_entity'];
        $specificities['select_items_options_2']['itemtypes']       = $CFG_ZENTRA['directconnect_types'];
    ...
    private static function showForAsset(CommonDBTM $asset, $withtemplate = 0): void
    {
        ...
        if (
            ...
            if ($asset->isRecursive()) {
                $entities = getSonsOf("zentra_entities", $asset->getEntityID());
            }
            ...
            TemplateRenderer::getInstance()->display('components/form/link_existing_or_new.html.twig', [
                ...
                'link_types' => $CFG_ZENTRA['directconnect_types'],
                'generic_source' => true,
                'generic_target' => true,
    ...
    private static function showForPeripheral(CommonDBTM $peripheral, $withtemplate = 0): void
    {
        ...
        if (
            ...
            if ($peripheral->isRecursive()) {
                $entities = getSonsOf("zentra_entities", $peripheral->getEntityID());
            }
            $dropdown_params = [
            ...
            echo TemplateRenderer::getInstance()->renderFromStringTemplate(<<<TWIG
                ...
                <div class="mb-3">
                    <form method="post" action="{{ 'Zentra\\\\Asset\\\\Asset_PeripheralAsset'|itemtype_form_path }}">
...
TWIG, $twig_params);
    ...
    public static function unglobalizeItem(CommonDBTM $item): bool
    {
        ...
        if (
            !\in_array($item::class, $CFG_ZENTRA['directconnect_types'], true)
    ...
    public static function dropdownConnect(
        ...
        echo Html::jsAjaxDropdown(
            $myname,
            $field_id,
            $CFG_ZENTRA['root_doc'] . "/ajax/getDropdownConnect.php",
            $param
        );
    ...
    public function getTabNameForItem(CommonZENTRA $item, $withtemplate = 0): string
    {
        ...
        if ($item->can($item->getID(), READ)) {
            ...
            if (in_array($item::class, $CFG_ZENTRA['directconnect_types'], true)) {
                $canview = true;
                ...
                if ($canview && $_SESSION['zentrashow_count_on_tabs']) {
    ...
    public static function rawSearchOptionsToAdd($itemtype = null)
    {
        ...
        $tab = [];
        $peripherals = $CFG_ZENTRA['directconnect_types'];
    ...
    public static function getRelationMassiveActionsPeerForSubForm(MassiveAction $ma)
    {
        ...
        if (
            count(array_intersect(
                array_keys($items),
                $CFG_ZENTRA['directconnect_types']
            )) > 0
        ) {
            return 1;
        }
    ...
    public static function getPeripheralHostItemtypes(): array
    {
        ...
        return $CFG_ZENTRA['peripheralhost_types'];
    }
