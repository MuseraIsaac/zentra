...
class HasImpactCapacity extends AbstractCapacity
{
    ...
    public function onClassBootstrap(string $classname, CapacityConfig $config): void
    {
        ...
        $CFG_ZENTRA['impact_asset_types'][$classname] = Toolbox::getPictureUrl(
            $classname::getDefinition()->fields['picture'],
            false
        );

        CommonZENTRA::registerStandardTab($classname, Impact::class, 2);
    }
    ...
    public function onCapacityDisabled(string $classname, CapacityConfig $config): void
    {
        ...
        unset($CFG_ZENTRA['impact_asset_types'][$classname]);
