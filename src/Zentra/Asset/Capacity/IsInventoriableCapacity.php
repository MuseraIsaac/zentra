...
class IsInventoriableCapacity extends AbstractCapacity
{
    ...
    {
        return __("The ZENTRA agent can report inventory data for these assets.");
    }
    ...
    public function onClassBootstrap(string $classname, CapacityConfig $config): void
    {
        ...
        CommonZENTRA::registerStandardTab($classname, Item_Environment::class, 85);
        CommonZENTRA::registerStandardTab($classname, Item_Process::class, 85);
    }
