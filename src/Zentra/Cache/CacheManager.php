...
{
    /**
     * ZENTRA core cache context.
     * @var string
     */
    public const CONTEXT_CORE = 'core';

    /**
     * ZENTRA translations cache context.
     * @var string
     */
    ...
    public function __construct(string $config_dir = ZENTRA_CONFIG_DIR, ?string $cache_dir = null)
    {
        if ($cache_dir === null) {
