...
namespace Zentra\Console\Build;
...
class GenerateCodeManifestCommand extends Command
{
    protected function configure()
    {
        ...
        $this->setDescription(__('Generate ZENTRA source code manifest that could be used to validate source code integrity.'));
        $this->addOption(
            'algorithm',
            'a',
    ...
    {
        $manifest_output = ZENTRA_ROOT . '/version/' . VersionParser::getNormalizedVersion(ZENTRA_VERSION, false);
