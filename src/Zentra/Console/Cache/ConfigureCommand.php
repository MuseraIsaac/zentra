...
namespace Zentra\Console\Cache;
...
class ConfigureCommand extends AbstractCommand implements ConfigurationCommandInterface
{
    ...
    protected function configure()
    {
        ...
        $this->addUsage('--dsn=memcached://cache1.zentra-project.org --dsn=memcached://cache2.zentra-project.org');
        $this->addUsage('--dsn=redis://redis.zentra-project.org:6379/zentra');
        ...
        $help_lines = [
            ...
            '',
            __('Cache namespace can be use to ensure either separation or sharing of multiple ZENTRA instances data on same cache system.'),
        ];
