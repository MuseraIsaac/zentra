...
final class CheckDocumentsIntegrityCommand extends AbstractCommand
{
    ...
    protected function configure()
    {
        ...
        $this->setDescription(__("Validate files integrity for ZENTRA's documents."));
    }
     ...
     * Validate a document
     *
     * @param array $row Simplified row of zentra_documents (id, filepath, sha1sum, filename)
     *
    ...
    protected function validateDocument(array $row): int
    {
        ...
        $path = ZENTRA_DOC_DIR . '/' . $row['filepath'];
        if (!file_exists($path)) {
