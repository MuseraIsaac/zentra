...
/**
 * Prior from ZENTRA 10.0, some HTML contents were not properly encoded.
 *
...
final class CheckHtmlEncodingCommand extends AbstractCommand
{
     ...
     * @see https://github.com/zentra-project/zentra/issues/8330
     *
     * @param string $input
     * @return string
     */
     ...
     * @see https://github.com/zentra-project/zentra/pull/6084
     *
     * @param string $input
     * @return string
     */
    ...
    private function findTextFields(): void
    {
        ...
        foreach ($table_iterator as $table_data) {
            ...
            if ((new ReflectionClass($itemtype))->isAbstract()) {
                ...
                // Anyway, corresponding classes were introduced in ZENTRA 11.0 and corresponding tables
