...
abstract class AbstractPluginToCoreCommand extends AbstractCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!$no_interaction) {
            ...
            $output->writeln(
                [
                    sprintf(__('You are about to launch migration of "%s" plugin data into ZENTRA core tables.'), $this->getPluginKey()),
     ...
     * Throws a `\Zentra\Console\Exception\EarlyExitException` unless `skip-errors` option is used.
     *
