...
class DatabasesPluginToCoreCommand extends AbstractPluginToCoreCommand
{
    protected function configure()
    {
        ...
        $this->setDescription(sprintf(__('Migrate %s plugin data into ZENTRA core tables'), 'Databases'));
    }
    ...
    {
        return [
            'zentra_plugin_databases_databases.id',
            'zentra_plugin_databases_databases.entities_id',
            'zentra_plugin_databases_databases.is_recursive',
            'zentra_plugin_databases_databases.name',
            'zentra_plugin_databases_databases.is_deleted',
            'zentra_plugin_databases_databases.plugin_databases_databasetypes_id',
            'zentra_plugin_databases_databases.plugin_databases_databasecategories_id',
            'zentra_plugin_databases_databases.comment',
            'zentra_plugin_databases_databases.locations_id',
            'zentra_plugin_databases_databases.manufacturers_id',
            'zentra_plugin_databases_databases.suppliers_id',
            'zentra_plugin_databases_databases.users_id',
            'zentra_plugin_databases_databases.groups_id',
            'zentra_plugin_databases_databases.date_mod',
            'zentra_plugin_databases_databases.is_helpdesk_visible',

            'zentra_plugin_databases_instances.id',
            'zentra_plugin_databases_instances.entities_id',
            'zentra_plugin_databases_instances.is_recursive',
            'zentra_plugin_databases_instances.name',
            'zentra_plugin_databases_instances.plugin_databases_databases_id',

            'zentra_plugin_databases_databasetypes.id',
            'zentra_plugin_databases_databasetypes.name',
            'zentra_plugin_databases_databasetypes.comment',

            'zentra_plugin_databases_databasecategories.id',
            'zentra_plugin_databases_databasecategories.name',
            'zentra_plugin_databases_databasecategories.comment',
        ];
    }
    ...
    protected function migratePlugin(): void
    {
        ...
        global $CFG_ZENTRA;
        if (isset($CFG_ZENTRA["auto_create_infocoms"]) && $CFG_ZENTRA["auto_create_infocoms"]) {
            $CFG_ZENTRA['auto_create_infocoms'] = false;
        }
    ...
    private function importDatabaseInstanceCategories(): void
    {
        ...
        $iterator = $this->db->request([
            'FROM'  => 'zentra_plugin_databases_databasecategories',
            'ORDER' => 'id ASC',
        ]);
    ...
    private function importDatabases(): void
    {
        ...
        $iterator = $this->db->request([
            'FROM'  => 'zentra_plugin_databases_instances', // Database in ZENTRA core corresponds to PluginDatabasesInstance
            'ORDER' => 'id ASC',
        ]);
    ...
    private function importDatabaseInstances(): void
    {
        ...
        $iterator = $this->db->request([
            'FROM'  => 'zentra_plugin_databases_databases', // Database in ZENTRA core corresponds to PluginDatabasesDatabase
            'ORDER' => 'id ASC',
        ]);
        ...
        foreach ($progress_bar->iterate($iterator) as $instance_data) {
            ...
            //try to load related item from 'zentra_plugin_databases_databases_items'
            $related_item_iterator = $this->db->request([
                'FROM'  => 'zentra_plugin_databases_databases_items',
                'WHERE' => [
    ...
    private function importDatabaseInstanceTypes(): void
    {
        ...
        $iterator = $this->db->request([
            'FROM'  => 'zentra_plugin_databases_databasetypes',
            'ORDER' => 'id ASC',
        ]);
