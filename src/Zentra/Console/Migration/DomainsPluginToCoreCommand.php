...
class DomainsPluginToCoreCommand extends AbstractPluginToCoreCommand
{
    protected function configure()
    {
        ...
        $this->setDescription(sprintf(__('Migrate %s plugin data into ZENTRA core tables'), 'Domains'));
    }
    ...
    {
        return [
            'zentra_plugin_domains_domains.id',
            'zentra_plugin_domains_domains.name',
            'zentra_plugin_domains_domains.comment',
            'zentra_plugin_domains_domains.entities_id',
            'zentra_plugin_domains_domains.is_recursive',
            'zentra_plugin_domains_domains.is_deleted',
            'zentra_plugin_domains_domains.date_creation',
            'zentra_plugin_domains_domains.date_mod',
            'zentra_plugin_domains_domains.date_expiration',
            'zentra_plugin_domains_domains.plugin_domains_domaintypes_id',
            'zentra_plugin_domains_domains.users_id_tech',
            'zentra_plugin_domains_domains.groups_id_tech',
            'zentra_plugin_domains_domains.suppliers_id',

            'zentra_plugin_domains_domaintypes.id',
            'zentra_plugin_domains_domaintypes.name',
            'zentra_plugin_domains_domaintypes.entities_id',
            'zentra_plugin_domains_domaintypes.comment',

            'zentra_plugin_domains_domains_items.plugin_domains_domains_id',
            'zentra_plugin_domains_domains_items.itemtype',
            'zentra_plugin_domains_domains_items.items_id',
        ];
    }
    ...
    protected function importDomainTypes(): void
    {
        ...
        $types_iterator = $this->db->request([
            'FROM'   => 'zentra_plugin_domains_domaintypes',
            'ORDER'  => 'id ASC',
        ]);
    ...
    protected function importDomains(): void
    {
        ...
        $domains_iterator = $this->db->request([
            'FROM'   => 'zentra_plugin_domains_domains',
            'ORDER'  => 'id ASC',
        ]);
    ...
    protected function importDomainItems(): void
    {
        ...
        $items_iterator = $this->db->request([
            'FROM'   => 'zentra_plugin_domains_domains_items',
            'ORDER'  => 'id ASC',
        ]);
