...
namespace Zentra\Console\Plugin;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($pluglist as $plugin) {
            ...
            if ($input->getOption('path')) {
                ...
                $record['path'] = $is_marketplace ? ZENTRA_MARKETPLACE_DIR . $dir_sep . $plugin['directory'] : ZENTRA_ROOT . "{$dir_sep}plugins{$dir_sep}" . $plugin['directory'];
            }
            $data[] = $record;
        }
