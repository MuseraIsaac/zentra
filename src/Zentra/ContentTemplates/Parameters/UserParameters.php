...
namespace Zentra\ContentTemplates\Parameters;

use CommonDBTM;
use Zentra\ContentTemplates\Parameters\ParametersTypes\ArrayParameter;
use Zentra\ContentTemplates\Parameters\ParametersTypes\AttributeParameter;
use Zentra\ContentTemplates\Parameters\ParametersTypes\ObjectParameter;
use Location;
use User;
use UserCategory;
use UserEmail;
...
class UserParameters extends AbstractParameters
{
    ...
    protected function defineValues(CommonDBTM $user): array
    {
        ...
        // Add assets
        $values['used_items'] = [];
        foreach ($CFG_ZENTRA["asset_types"] as $asset_type) {
