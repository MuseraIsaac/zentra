...
namespace Zentra\Controller\Form\Translation;

use Zentra\Controller\Translation\AbstractTranslationController;
...
final class UpdateFormTranslationController extends AbstractTranslationController
{
    ...
    #[Route("/Form/Translation/{form_id}/{language}", name: "zentra_update_form_translation", methods: "POST")]
