...
final class InventoryController extends AbstractController
{
    ...
    #[Route("/Inventory", name: "zentra_inventory", methods: ['GET', 'POST'])]
    #[Route("/front/inventory.php", name: "zentra_inventory_legacy", methods: ['GET', 'POST'])]
    public function index(Request $request): Response
    {
        ...
        $inventory_request = new \Zentra\Inventory\Request();
    ...
    #[Route("/Inventory/RefusedEquipment", name: "zentra_refused_inventory", methods: 'POST')]
    ...
    #[Route("/Inventory/Configuration", name: "zentra_inventory_configuration", methods: ['GET'])]
    #[Route("/front/inventory.conf.php", name: "zentra_inventory_configuration_legacy", methods: ['GET'])]
    ...
    #[Route("/Inventory/Configuration/Store", name: "zentra_inventory_store_configuration", methods: ['POST'])]
    #[Route("/front/inventory.conf.php", name: "zentra_inventory_store_configuration_legacy", methods: ['POST'])]
    public function storeConfiguration(Request $request): Response
    {
        ...
        return new RedirectResponse($this->router->generate('zentra_inventory_configuration'));
    }

    #[Route("/Inventory/ImportFiles", name: "zentra_inventory_report", methods: ['POST'])]
