...
{
    public const REQUEST_FILE_KEY = '_zentra_file_to_load';
    ...
    public function __invoke(Request $request): Response
    {
        ...
        if (\headers_sent()) {
            ...
            // @phpstan-ignore-next-line method.deprecatedClass (deprecated usage is intended for backward compatibility, this BC layer will be removed in the next ZENTRA major version)
