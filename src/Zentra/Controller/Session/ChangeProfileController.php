...
namespace Zentra\Controller\Session;
...
final class ChangeProfileController extends AbstractController
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        if (!isset($_SESSION["zentraprofiles"][$profile_id])) {
        ...
        if (Session::getCurrentInterface() == "helpdesk") {
            $go_to_create_ticket = $_SESSION['zentraactiveprofile']['create_ticket_on_login'];
