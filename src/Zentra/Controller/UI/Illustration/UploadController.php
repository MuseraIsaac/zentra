...
namespace Zentra\Controller\UI\Illustration;
...
final class UploadController extends AbstractController
{
    ...
    #[Route(
        ...
        name: "zentra_ui_illustration_upload",
        methods: "POST",
    )]
    public function __invoke(Request $request): Response
    {
        ...
        $file_path = realpath(ZENTRA_TMP_DIR . "/$file_name");

        if (
            empty($file_name)
            || !str_starts_with($file_path, realpath(ZENTRA_TMP_DIR))
