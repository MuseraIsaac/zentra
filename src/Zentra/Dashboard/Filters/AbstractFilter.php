...
namespace Zentra\Dashboard\Filters;
...
abstract class AbstractFilter
{
    ...
    */
     ...
     * [
     * 'link'       => 'AND',
     * 'field'      => self::getSearchOptionID($table, 'itilcategories_id', 'zentra_itilcategories'), // itilcategory
     * 'searchtype' => 'under',
    ...
    protected static function displayList(
        ...
        $js = "
            var on_change_{$rand} = function() {
                ...
                ZENTRA.Dashboard.getActiveDashboard().saveFilter('" . \jsescape($fieldname) . "', selected);
