    ...
    public static function nbTicketsGeneric(
        ...
        switch ($case) {
            ...
            case 'late':
                ...
                $query_criteria['WHERE'][] = [
                    'OR' => [
                        CommonITILObject::generateSLAOLAComputation('time_to_resolve', 'zentra_tickets'),
                        CommonITILObject::generateSLAOLAComputation('internal_time_to_resolve', 'zentra_tickets'),
                        CommonITILObject::generateSLAOLAComputation('time_to_own', 'zentra_tickets'),
                        CommonITILObject::generateSLAOLAComputation('internal_time_to_own', 'zentra_tickets'),
                    ],
                ];
                break;
            ...
            case 'waiting_validation':
                ...
                $where = [
                    'NOT' => ['zentra_tickets.status' => [...Ticket::getSolvedStatusArray(), ...Ticket::getClosedStatusArray()]],
                ...
                // Join zentra_ticketvalidations table if not already done
                if (!isset($query_criteria['LEFT JOIN']['zentra_ticketvalidations'])) {
                    $query_criteria['LEFT JOIN']['zentra_ticketvalidations'] = [
                        'ON' => [
