...
class Widget
{
    ...
    public static function getAllTypes(): array
    {
        ...
        $types = [
            'pie' => [
                'label'      => __("Pie"),
                'function'   => 'Zentra\\Dashboard\\Widget::pie',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/pie.png',
                'haspalette' => true,
                'gradient'   => true,
                'limit'      => true,
                'legend'     => true,
            ...
            'donut' => [
                'label'      => __("Donut"),
                'function'   => 'Zentra\\Dashboard\\Widget::donut',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/donut.png',
                'haspalette' => true,
                'gradient'   => true,
                'limit'      => true,
                'legend'     => true,
            ...
            'halfpie' => [
                'label'      => __("Half pie"),
                'function'   => 'Zentra\\Dashboard\\Widget::halfPie',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/halfpie.png',
                'haspalette' => true,
                'gradient'   => true,
                'limit'      => true,
                'legend'     => true,
            ...
            'halfdonut' => [
                'label'      => __("Half donut"),
                'function'   => 'Zentra\\Dashboard\\Widget::halfDonut',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/halfdonut.png',
                'haspalette' => true,
                'gradient'   => true,
                'limit'      => true,
                'legend'     => true,
            ...
            'bar' => [
                'label'      => __("Bars"),
                'function'   => 'Zentra\\Dashboard\\Widget::simpleBar',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/bar.png',
                'haspalette' => true,
                'gradient'   => true,
                'limit'      => true,
                'pointlbl'   => true,
            ...
            'line' => [
                ...
                'function'   => 'Zentra\\Dashboard\\Widget::simpleLine',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/line.png',
                'haspalette' => false,
                'limit'      => true,
                'pointlbl'   => true,
                'legend'     => true,
            ...
            'lines' => [
                ...
                'function'   => 'Zentra\\Dashboard\\Widget::multipleLines',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/line.png',
                'haspalette' => true,
                'gradient'   => true,
                'limit'      => true,
            ...
            'area' => [
                'label'      => __("Area"),
                'function'   => 'Zentra\\Dashboard\\Widget::simpleArea',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/area.png',
                'haspalette' => true,
                'gradient'   => true,
                'limit'      => true,
                'pointlbl'   => true,
            ...
            'areas' => [
                ...
                'function'   => 'Zentra\\Dashboard\\Widget::multipleAreas',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/area.png',
                'haspalette' => true,
                'gradient'   => true,
                'limit'      => true,
            ...
            'bars' => [
                ...
                'function'   => 'Zentra\\Dashboard\\Widget::multipleBars',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/bar.png',
                'haspalette' => true,
                'gradient'   => true,
                'limit'      => true,
            ...
            'hBars' => [
                ...
                'function'   => 'Zentra\\Dashboard\\Widget::multipleHBars',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/hbar.png',
                'haspalette' => true,
                'gradient'   => true,
                'limit'      => true,
                'pointlbl'   => true,
            ...
            'stackedbars' => [
                ...
                'function'   => 'Zentra\\Dashboard\\Widget::StackedBars',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/stacked.png',
                'haspalette' => true,
                'gradient'   => true,
                'limit'      => true,
                'pointlbl'   => true,
            ...
            'stackedHBars' => [
                ...
                'function'   => 'Zentra\\Dashboard\\Widget::stackedHBars',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/hstacked.png',
                'haspalette' => true,
                'gradient'   => true,
                'limit'      => true,
                'pointlbl'   => true,
            ...
            'hbar' => [
                ...
                'function'   => 'Zentra\\Dashboard\\Widget::simpleHbar',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/hbar.png',
                'haspalette' => true,
                'gradient'   => true,
                'limit'      => true,
            ...
            'bigNumber' => [
                'label'    => __("Big number"),
                'function' => 'Zentra\\Dashboard\\Widget::bigNumber',
                'image'    => $CFG_ZENTRA['root_doc'] . '/pics/charts/bignumber.png',
            ],
            'multipleNumber' => [
                'label'      => __("Multiple numbers"),
                'function'   => 'Zentra\\Dashboard\\Widget::multipleNumber',
                'image'      => $CFG_ZENTRA['root_doc'] . '/pics/charts/multiplenumbers.png',
                'limit'      => true,
                'haspalette' => true,
                'gradient'   => true,
                'width'      => 3,
            ...
            'markdown' => [
                ...
                'function' => 'Zentra\\Dashboard\\Widget::markdown',
                'image'    => $CFG_ZENTRA['root_doc'] . '/pics/charts/markdown.png',
                'width'    => 4,
                'height'   => 4,
            ],
            'searchShowList' => [
                'label'    => __("Search result"),
                'function' => 'Zentra\\Dashboard\\Widget::searchShowList',
                'image'    => $CFG_ZENTRA['root_doc'] . '/pics/charts/table.png',
                'limit'    => true,
                'width'    => 5,
                'height'   => 4,
            ],
            'summaryNumbers' => [
                ...
                'function' => 'Zentra\\Dashboard\\Widget::summaryNumber',
                'image'    => $CFG_ZENTRA['root_doc'] . '/pics/charts/summarynumber.png',
                'limit'    => true,
                'gradient' => true,
                'width'    => 4,
                'height'   => 2,
            ...
            'articleList' => [
                ...
                'function' => 'Zentra\\Dashboard\\Widget::articleList',
                'image'    => $CFG_ZENTRA['root_doc'] . '/pics/charts/articles.png',
                'limit'    => true,
                'width'    => 3,
                'height'   => 4,
            ],
        ...
        $js = TemplateRenderer::getInstance()->renderFromStringTemplate(<<<TWIG
            <script type="module">
                (async () => {
                    ...
                    const target = ZENTRA.Dashboard.getActiveDashboard() ?
                        ZENTRA.Dashboard.getActiveDashboard().element.find('#{{ chart_id }} .chart')
                        : $('#{{ chart_id }} .chart');
...
HTML;
     ...
     *
     * @param array $params contains these keys:
     * - string 'itemtype': Zentra oObject to search
