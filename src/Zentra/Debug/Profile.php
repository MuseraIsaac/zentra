...
final class Profile
{
    ...
    public static function getCurrent(): self
    {
        if (self::$current === null) {
            $id = $_SERVER['HTTP_X_ZENTRA_AJAX_ID'] ?? bin2hex(random_bytes(8));
            $parent_id = $_SERVER['HTTP_X_ZENTRA_AJAX_PARENT_ID'] ?? null;
    ...
    {
        if (($_SESSION['zentra_use_mode'] ?? null) !== Session::DEBUG_MODE) {
