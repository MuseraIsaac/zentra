...
use Zentra\Error\ErrorDisplayHandler\CliDisplayHandler;
use Zentra\Error\ErrorDisplayHandler\ConsoleErrorDisplayHandler;
use Zentra\Error\ErrorDisplayHandler\ErrorDisplayHandler;
use Zentra\Error\ErrorDisplayHandler\HtmlErrorDisplayHandler;
use Monolog\Logger;
use Override;
...
final class ErrorHandler extends BaseErrorHandler
{
    ...
    public function handleError(int $type, string $message, string $file, int $line): bool
    {
        if (0 === (error_reporting() & $type)) {
            // ZENTRA does not log silented errors, they should just be ignored.
            return true;
        }
        ...
        // to be logged in the ZENTRA error log.
        return true;
    }
    ...
    private function configureErrorReporting(): void
    {
        ...
        $monolog_level = Logger::toMonologLevel(ZENTRA_LOG_LVL);
