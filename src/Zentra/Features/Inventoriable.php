...
trait Inventoriable
{
     ...
     *
     * @param bool $prepend_dir_path Indicated whether the ZENTRA_INVENTORY_DIR have to be prepended to returned value.
     *
     * @return string|null
     */
    public function getInventoryFileName(bool $prepend_dir_path = true): ?string
    {
        ...
        $inventory_dir_path = ZENTRA_INVENTORY_DIR . '/';
    ...
    protected function showInventoryInfo()
    {
        ...
        if ($download_file !== null) {
            ...
            if (static::class === RefusedEquipment::class) { //@phpstan-ignore-line - phpstan bug with traits
                $url = \htmlescape($CFG_ZENTRA['root_doc'] . '/Inventory/RefusedEquipment');
