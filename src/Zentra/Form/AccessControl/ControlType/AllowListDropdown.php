...
namespace Zentra\Form\AccessControl\ControlType;
...
final class AllowListDropdown extends AbstractRightsDropdown
{
    ...
    protected static function getAjaxUrl(): string
    {
        ...
        return $CFG_ZENTRA['root_doc'] . "/ajax/form/allowListDropdownValue.php";
    }
