...
namespace Zentra\Form\Export\Serializer;
...
use Zentra\Form\Condition\ConditionableInterface;
...
use Zentra\Form\Export\Result\ExportResult;
use Zentra\Form\Export\Result\ImportError;
use Zentra\Form\Export\Result\ImportResult;
use Zentra\Form\Export\Result\ImportResultIssues;
use Zentra\Form\Export\Result\ImportResultPreview;
use Zentra\Form\Export\Specification\AccesControlPolicyContentSpecification;
use Zentra\Form\Export\Specification\CommentContentSpecification;
use Zentra\Form\Export\Specification\ConditionDataSpecification;
use Zentra\Form\Export\Specification\CustomIllustrationContentSpecification;
use Zentra\Form\Export\Specification\CustomTypeRequirementSpecification;
use Zentra\Form\Export\Specification\DataRequirementSpecification;
use Zentra\Form\Export\Specification\DestinationContentSpecification;
use Zentra\Form\Export\Specification\ExportContentSpecification;
use Zentra\Form\Export\Specification\FormContentSpecification;
use Zentra\Form\Export\Specification\PluginRequirementSpecification;
use Zentra\Form\Export\Specification\QuestionContentSpecification;
use Zentra\Form\Export\Specification\SectionContentSpecification;
use Zentra\Form\Export\Specification\TranslationContentSpecification;
...
final class FormSerializer extends AbstractFormSerializer
{
    ...
    private function prepareIllustrationDataForImport(
        ...
        $tmp_path = ZENTRA_TMP_DIR . "/" . $illustration->key;
