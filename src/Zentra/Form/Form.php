...
use Zentra\Form\Clone\FormCloneHelper;
use Zentra\Form\Condition\CommentData;
use Zentra\Form\Condition\ConditionableVisibilityInterface;
use Zentra\Form\Condition\ConditionableVisibilityTrait;
use Zentra\Form\Condition\FormData;
use Zentra\Form\Condition\QuestionData;
use Zentra\Form\Condition\SectionData;
    ...
    ConditionableVisibilityInterface
{
    ...
    public static function showMassiveActionsSubForm(MassiveAction $ma): bool
    {
        ...
        $export_url = $CFG_ZENTRA['url_base'];
