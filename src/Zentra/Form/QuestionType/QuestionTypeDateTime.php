...
use Zentra\Form\Condition\ConditionHandler\DateAndTimeConditionHandler;
use Zentra\Form\Condition\ConditionHandler\DateConditionHandler;
use Zentra\Form\Condition\ConditionHandler\TimeConditionHandler;
    ...
    public function renderAdministrationTemplate(?Question $question): string
    {
        $template = <<<TWIG
            ...
            <div class="row g-2">
                ...
                <div data-zentra-form-editor-question-extra-details class="col-auto d-flex align-items-center ms-1 mt-0">
            ...
            {% if question == null %}
                <script>
                    import("/js/modules/Forms/QuestionDateTime.js").then((m) => {
                        new m.ZentraFormQuestionTypeDateTime({{ placeholders|json_encode|raw }});
                    });
                </script>
            {% endif %}
TWIG;
