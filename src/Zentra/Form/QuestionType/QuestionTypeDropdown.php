        ...
        $js = <<<TWIG
            import("/js/modules/Forms/QuestionDropdown.js").then((m) => {
                {% if question is not null %}
                    ...
                    container.data(
                        'manager',
                        new m.ZentraFormQuestionTypeDropdown('{{ input_type|escape('js') }}', container)
                    );
                {% else %}
                    $(document).on('zentra-form-editor-question-type-changed', function(e, question, type) {
                        if (type === '{{ question_type|escape('js') }}') {
                            ...
                            container.data(
                                'manager',
                                new m.ZentraFormQuestionTypeDropdown('{{ input_type|escape('js') }}', container, true)
                            );
                        }
                    });
...
TWIG;
    ...
    public function renderAdministrationTemplate(?Question $question): string
    {
        ...
        <div data-zentra-form-editor-preview-dropdown>
