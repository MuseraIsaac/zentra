...
use Zentra\Form\Condition\ConditionHandler\ItemAsTextConditionHandler;
use Zentra\Form\Condition\ConditionHandler\ItemConditionHandler;
    ...
    ConditionValueTransformerInterface
{
    ...
    public function getAllowedItemtypes(): array
    {
        ...
        return [
            ...
            __('Assistance') => array_merge(
                $CFG_ZENTRA['itil_types'],
                [
                    TicketRecurrent::class,
                ]
            ),
            __('Management') => $CFG_ZENTRA['management_types'],
            __('Tools') => $CFG_ZENTRA['tools_types'],
            __('Administration') => $CFG_ZENTRA['admin_types'],
        ];
    }
    ...
    public function renderEndUserTemplate(Question $question): string
    {
        ...
        $is_itil_type = in_array($itemtype, $CFG_ZENTRA['itil_types']);
        $id_already_visible = isset($_SESSION['zentrais_ids_visible']) && $_SESSION['zentrais_ids_visible'];
        ...
        if (in_array($itemtype, $CFG_ZENTRA['asset_types'])) {
    ...
    {
        return _n('ZENTRA Object', 'ZENTRA Objects', Session::getPluralNumber());
    }
