...
use Zentra\Form\Condition\ConditionHandler\RichTextConditionHandler;
        ...
        return <<<JS
            {
                "extractDefaultValue": function (question) {
                    const ZentraFormEditorConvertedExtractedDefaultValue = $("[data-zentra-form-editor-container]")
                        .data('EditorConvertedExtractedDefaultValue')
                    ;

                    const textarea = question.find('[data-zentra-form-editor-question-type-specific]')
                        .find('[name="default_value"], [data-zentra-form-editor-original-name="default_value"]');
                    ...
                    return new ZentraFormEditorConvertedExtractedDefaultValue(
                        ZentraFormEditorConvertedExtractedDefaultValue.DATATYPE.STRING,
                        content
                    );
                },
                "convertDefaultValue": function (question, value) {
                    ...
                    if (value.getDatatype() !== ZentraFormEditorConvertedExtractedDefaultValue.DATATYPE.STRING) {
                        return '';
                    }
