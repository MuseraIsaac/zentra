...
use Zentra\Form\Condition\ConditionHandler\UserDevicesAsTextConditionHandler;
use Zentra\Form\Condition\ConditionHandler\UserDevicesConditionHandler;
        ...
        $template = <<<TWIG
            ...
            <script>
                function handleMultipleDevicesCheckbox_{{ rand }}(input) {
                    ...
                    const selects = $(input).closest('section[data-zentra-form-editor-question]')
