...
use Zentra\ItemTranslation\ItemTranslation;
use ITILCategory;
use Location;
...
final class DefaultDataManager
{
    ...
    public function initializeData(): void
    {
        ...
        $this->tiles_manager->addTile($root_entity, ZentraPageTile::class, [
        ...
        $this->tiles_manager->addTile($root_entity, ZentraPageTile::class, [
            ...
            'page'         => ZentraPageTile::PAGE_ALL_TICKETS,
        ]);
        ...
        $this->tiles_manager->addTile($root_entity, ZentraPageTile::class, [
            ...
            'page'         => ZentraPageTile::PAGE_RESERVATION,
        ]);
    ...
    {
        global $CFG_ZENTRA, $DB, $TRANSLATE;
        ...
        foreach (array_keys($CFG_ZENTRA['languages']) as $lang) {
