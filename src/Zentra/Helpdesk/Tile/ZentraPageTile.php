...
final class ZentraPageTile extends CommonDBTM implements TileInterface, ProvideTranslationsInterface
{
    ...
    {
        return "pages/admin/zentra_page_tile_config_fields.html.twig";
    }
