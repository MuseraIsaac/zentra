...
class Response extends \GuzzleHttp\Psr7\Response
{
    ...
    {
        Toolbox::deprecated('Response::sendError() is deprecated. Throw a `Zentra\Exception\Http\*HttpException` exception instead.');
        ...
        echo($output);
        exit(1); // @phpstan-ignore zentra.forbidExit (Deprecated scope)
    }
    ...
    public function sendHeaders(): Response
    {
        ...
        http_response_code($this->getStatusCode()); // @phpstan-ignore zentra.forbidHttpResponseCode (Deprecated scope)
        return $this;
    }
