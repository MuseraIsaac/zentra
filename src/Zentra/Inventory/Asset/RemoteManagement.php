...
class RemoteManagement extends InventoryAsset
{
    public function prepare(): array
    {
        ...
        if (!in_array($this->item->getType(), $CFG_ZENTRA['remote_management_types'])) {
            throw new RuntimeException(
                'Remote Management are handled for following types only: '
                . implode(', ', $CFG_ZENTRA['remote_management_types'])
            );
        }
    ...
    {
        global $CFG_ZENTRA;
        return in_array($this->item::class, $CFG_ZENTRA['remote_management_types']);
    }
