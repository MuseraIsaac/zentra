...
class VirtualMachine extends InventoryAsset
{
    ...
    public function prepare(): array
    {
        ...
        if (!in_array($this->item->getType(), $CFG_ZENTRA['itemvirtualmachines_types'])) {
    ...
    protected function createVmComputer()
    {
        ...
        foreach ($this->data as $vm) {
            ...
            $vm->last_inventory_update = $_SESSION["zentra_currenttime"];
    ...
    public function checkConf(Conf $conf): bool
    {
        global $CFG_ZENTRA;
        $this->conf = $conf;
        return $conf->import_vm == 1 && in_array($this->item::class, $CFG_ZENTRA['itemvirtualmachines_types']);
    }
