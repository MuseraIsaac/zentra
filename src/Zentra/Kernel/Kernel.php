...
use Zentra\Application\SystemConfigurator;
use Override;
...
final class Kernel extends BaseKernel
{
    ...
    public function __construct(?string $env = null)
    {
        ...
        // It must be done after the autoload inclusion that requires some constants to be defined (e.g. ZENTRA_VERSION).
    ...
    public static function getCacheRootDir(): string
    {
        ...
        return ZENTRA_CACHE_DIR . '/' . ZENTRA_FILES_VERSION . '-' . Environment::get()->value;
    }
    ...
    protected function configureRoutes(RoutingConfigurator $routes): void
    {
        ...
        $routes->import($this->getProjectDir() . '/src/Zentra/Controller', 'attribute');
     ...
     * occurs when handling the ZENTRA legacy scripts using a streamed response, but may also rarely occurs
     * in other contexts.
     *
