...
namespace Zentra\Kernel\Listener\ControllerListener;
...
final readonly class CheckCsrfListener implements EventSubscriberInterface
{
    ...
    public function onKernelController(ControllerEvent $event): void
    {
        ...
        if ($request->isXmlHttpRequest()) {
            // For AJAX requests, check CSRF token located into "X-Zentra-Csrf-Token" header.
            Session::checkCSRF(
                ['_zentra_csrf_token' => $request->server->get('HTTP_X_ZENTRA_CSRF_TOKEN') ?? ''],
