...
namespace Zentra\Kernel;

use Zentra\Kernel\Listener\PostBootListener\BootPlugins;
use Zentra\Kernel\Listener\PostBootListener\CheckPluginsStates;
use Zentra\Kernel\Listener\PostBootListener\CustomObjectsAutoloaderRegistration;
use Zentra\Kernel\Listener\PostBootListener\CustomObjectsBoot;
use Zentra\Kernel\Listener\PostBootListener\InitializeCache;
use Zentra\Kernel\Listener\PostBootListener\InitializeDbConnection;
use Zentra\Kernel\Listener\PostBootListener\InitializePlugins;
use Zentra\Kernel\Listener\PostBootListener\LoadLanguage;
use Zentra\Kernel\Listener\PostBootListener\LoadLegacyConfiguration;
use Zentra\Kernel\Listener\PostBootListener\ProfilerStart;
use Zentra\Kernel\Listener\PostBootListener\SessionStart;
use Zentra\Kernel\Listener\PostBootListener\SetDbSessionVars;
use Zentra\Kernel\Listener\RequestListener\CatchInventoryAgentRequestListener;
use Zentra\Kernel\Listener\RequestListener\CheckDatabaseStatusListener;
use Zentra\Kernel\Listener\RequestListener\CheckMaintenanceListener;
use Zentra\Kernel\Listener\RequestListener\ErrorHandlerRequestListener;
use Zentra\Kernel\Listener\RequestListener\FlushBootErrors;
use Zentra\Kernel\Listener\RequestListener\FrontEndAssetsListener;
use Zentra\Kernel\Listener\RequestListener\LegacyItemtypeRouteListener;
use Zentra\Kernel\Listener\RequestListener\LegacyRouterListener;
use Zentra\Kernel\Listener\RequestListener\PluginsRouterListener;
use Zentra\Kernel\Listener\RequestListener\RedirectLegacyRouteListener;
use Zentra\Kernel\Listener\RequestListener\SessionCheckCookieListener;
use Zentra\Kernel\Listener\RequestListener\SessionVariables;
...
final class ListenersPriority
{
    ...
    public const REQUEST_LISTENERS_PRIORITIES = [
        ...
        // This listener will prevent accessing ZENTRA if the maintenance mode is active.
