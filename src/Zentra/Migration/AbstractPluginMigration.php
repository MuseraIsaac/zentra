...
abstract class AbstractPluginMigration
{
    ...
    /**
     * Mapping between plugin items and ZENTRA core items.
     *
    ...
    final public function hasBeenExecuted(): bool
    {
        ...
        return (bool) ($CFG_ZENTRA[$this->getHasBeenExecutedConfigurationKey()] ?? false);
    }
    ...
    final protected function importItem(
        ...
        if ($reconciliation_criteria !== null && $item->getFromDBByCrit($reconciliation_criteria)) {
            ...
            if (
                ...
                // The item in ZENTRA has been modified after the last modification of the plugin item.
                // We consider the item from the plugin as outdated and preserve the ZENTRA item.
    ...
    final protected function copyPolymorphicConnexityItems(
        ...
        // TODO Deprecate this in ZENTRA 11.1.
            ...
            [
                ...
                'WHERE'  => [
                    ...
                    'OR' => [
                        ...
                        ['column_name'  => ['LIKE', 'items_id_%']],
                        [
                            // `zentra_ipaddresses.mainitems_id` polymorphic relation does not respect naming conventions
                            'table_name'   => 'zentra_ipaddresses',
    ...
    /**
     * Return the ZENTRA core item specs corresponding to the given plugin item.
     *
    ...
    /**
     * Return the ZENTRA core items specs corresponding to the given plugin itemtype.
     *
