...
namespace Zentra\OAuth;

use DateInterval;
use Zentra\Exception\OAuth2KeyException;
...
final class Server
{
    private const PRIVATE_KEY_PATH = ZENTRA_CONFIG_DIR . '/oauth.pem';
    private const PUBLIC_KEY_PATH  = ZENTRA_CONFIG_DIR . '/oauth.pub';
    ...
    public const ZENTRA_OAUTH_ACCESS_TOKEN_EXPIRES = 'PT1H';
    ...
    public function __construct()
    {
        ...
        $bearer_token_validator = new BearerTokenValidator(
            ...
            // equals to ZENTRA's time reference stored in the session.
        ...
        $encryption_key = (new ZENTRAKey())->get();
        ...
        $this->auth_server->enableGrantType(
            ...
            new DateInterval(self::ZENTRA_OAUTH_ACCESS_TOKEN_EXPIRES)
        );
