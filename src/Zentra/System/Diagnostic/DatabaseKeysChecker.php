    ...
    public function getMissingKeys(string $table_name): array
    {
        ...
        foreach ($columns as $column_name) {
            ...
            if (
                ...
                $ignored_fields = [
                    'zentra_ipaddresses.mainitems_id', // FIXME Should be renamed to zentra_ipaddresses.items_id_main to fit naming conventions.
                    'zentra_networkportaggregates.networkports_id_list', // FIXME Should be replaced by a relation table.
                    'zentra_planningexternalevents.users_id_guests', // FIXME Should be replaced by a relation table.
                    'zentra_dashboards_items.card_id', // FIXME This is not a foreign key.
                    'zentra_dashboards_items.gridstack_id', // FIXME This is not a foreign key.
                ];
