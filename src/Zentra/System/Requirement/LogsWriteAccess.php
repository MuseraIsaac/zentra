...
class LogsWriteAccess extends AbstractRequirement
{
    ...
    {
        // Only write test for ZENTRA_LOG as SElinux prevent removing log file.
        try {
            ...
            $this->validation_messages[] = sprintf(__('The log file could not be created in %s.'), ZENTRA_LOG_DIR);
        }
    }
}
