...
use Zentra\System\Requirement\DirectoriesWriteAccess;
use Zentra\System\Requirement\DirectoryWriteAccess;
use Zentra\System\Requirement\Extension;
use Zentra\System\Requirement\ExtensionConstant;
use Zentra\System\Requirement\ExtensionGroup;
use Zentra\System\Requirement\IntegerSize;
...
use Zentra\System\Requirement\SeLinux;
use Zentra\System\Requirement\SessionsConfiguration;
...
class RequirementsManager
{
    ...
    public function getCoreRequirementList(?DBmysql $db = null): RequirementsList
    {
        ...
        $requirements[] = new PhpVersion(ZENTRA_MIN_PHP, ZENTRA_MAX_PHP);
        ...
        $requirements[] = new ExtensionConstant(
            ...
            false,
            __('Enable usage of ChaCha20-Poly1305 encryption required by ZENTRA. This is provided by libsodium 1.0.12 and newer.')
        );
        $requirements[] = new Extension(
            'openssl',
            false,
        ...
        $requirements[] = new DirectoriesWriteAccess(
            __('Permissions for ZENTRA data directories'),
            array_filter(
                Variables::getDataDirectories(),
                function ($directory) {
                    return $directory !== ZENTRA_LOG_DIR; // Specifically checked by LogsWriteAccess requirement
                }
            )
        );
