...
final class IllustrationManager
{
     ...
     * them.
     */
    public const TRANSLATION_FILE = ZENTRA_ROOT . '/resources/.illustrations_translations.php';

    public const CUSTOM_ILLUSTRATION_PREFIX = "custom:";

    private const CUSTOM_ILLUSTRATION_DIR = ZENTRA_PICTURE_DIR . "/illustrations";

    public const CUSTOM_SCENE_PREFIX = "custom:";

    private const CUSTOM_SCENES_DIR = ZENTRA_PICTURE_DIR . "/scenes";
    ...
    public function __construct(
        ...
        $this->icons_definition_file = $icons_definition_file ?? ZENTRA_ROOT
            . '/public/lib/zentra-project/illustrations/icons.json'
        ;
        $this->icons_sprites_path = $icons_sprites_path
            ?? '/lib/zentra-project/illustrations/zentra-illustrations-icons.svg'
        ;
        $this->scenes_gradient_sprites_path = $scenes_gradient_sprites_path
            ?? '/lib/zentra-project/illustrations/zentra-illustrations-scenes-gradient.svg'
        ;

        $this->checkIconFile($this->icons_definition_file);
        $this->checkIconFile(ZENTRA_ROOT . "/public/$this->scenes_gradient_sprites_path");
        $this->checkIconFile(ZENTRA_ROOT . "/public/$this->icons_sprites_path");
    ...
    private function renderNativeIcon(string $icon_id, ?int $size = null): string
    {
        ...
        try {
            ...
            // see #21049
            $title = $TRANSLATE->translate("Icon\004" . ($icons[$icon_id]['title'] ?? ""), 'zentra');
