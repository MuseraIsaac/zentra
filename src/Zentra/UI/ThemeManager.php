...
class ThemeManager
{
    ...
    public const CORE_THEME_ROOT = ZENTRA_ROOT . '/css/palettes/';
    ...
    /**
     * Get all themes added by ZENTRA itself
     * @return Theme[]
     */
    ...
    /**
     * Get the Theme object for the current $_SESSION['zentrapalette'] value.
     *
     * If the "zentrapalette" value is not set, the default theme is used.
     * @return Theme
     */
    public function getCurrentTheme(): Theme
    {
        $current = $_SESSION['zentrapalette'] ?? self::DEFAULT_THEME;
