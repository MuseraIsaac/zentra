...
$CFG_ZENTRA['app_name'] = 'ZENTRA';

// dictionnaries
$CFG_ZENTRA['languages'] = [
...
// Init to store zentra itemtype / tables link
$CFG_ZENTRA['zentratables'] = [];

$CFG_ZENTRA['unicity_types']                = [
...
$CFG_ZENTRA['state_types']                  = [Computer::class, Monitor::class, NetworkEquipment::class,
...
$CFG_ZENTRA['ruleimportasset_types']                  = [Computer::class, Monitor::class, NetworkEquipment::class,
    Peripheral::class, Phone::class, Printer::class, SoftwareLicense::class,
    Certificate::class, Enclosure::class, PDU::class, Line::class,
    Rack::class, SoftwareVersion::class, Cluster::class, Contract::class,
    Appliance::class, DatabaseInstance::class, Cable::class, Unmanaged::class, PassiveDCEquipment::class,
...
$CFG_ZENTRA['asset_types']                  = [Computer::class, Monitor::class, NetworkEquipment::class,
    Peripheral::class, Phone::class, Printer::class, SoftwareLicense::class,
    Certificate::class, Unmanaged::class, Appliance::class,
];

$CFG_ZENTRA['project_asset_types']          = [Computer::class, Monitor::class, NetworkEquipment::class,
    Peripheral::class, Phone::class, Printer::class, Software::class,
...
$CFG_ZENTRA['document_types']               = [Budget::class, CartridgeItem::class, Change::class, Computer::class,
...
$CFG_ZENTRA['consumables_types']            = [Group::class, User::class];

$CFG_ZENTRA['report_types']                 = [Computer::class, Monitor::class, NetworkEquipment::class,
...
$CFG_ZENTRA['peripheralhost_types']         = [Computer::class];
$CFG_ZENTRA['directconnect_types']          = [Monitor::class, Peripheral::class, Phone::class, Printer::class];

$CFG_ZENTRA['infocom_types']                = [Cartridge::class, CartridgeItem::class, Computer::class,
...
$CFG_ZENTRA['reservation_types']            = [Computer::class, Monitor::class, NetworkEquipment::class,
    Peripheral::class, Phone::class, Printer::class, Software::class, Rack::class,
];

$CFG_ZENTRA['assignable_types'] = [
    Appliance::class,
    Cable::class,
    CartridgeItem::class,
    Certificate::class,
...
$CFG_ZENTRA['linkuser_types']         = $CFG_ZENTRA['assignable_types'];
$CFG_ZENTRA['linkgroup_types']        = $CFG_ZENTRA['assignable_types'];
$CFG_ZENTRA['linkuser_tech_types']    = $CFG_ZENTRA['assignable_types'];
$CFG_ZENTRA['linkgroup_tech_types']   = $CFG_ZENTRA['assignable_types'];

$CFG_ZENTRA['location_types']               = [Budget::class, CartridgeItem::class, ConsumableItem::class,
...
$CFG_ZENTRA['ticket_types']                 = [Computer::class, Monitor::class, NetworkEquipment::class,
    Peripheral::class, Phone::class, Printer::class, Software::class,
...
$CFG_ZENTRA['link_types']                   = [Budget::class, CartridgeItem::class, Computer::class,
...
$CFG_ZENTRA['dictionnary_types']            = [ComputerModel::class, ComputerType::class, Manufacturer::class,
...
$CFG_ZENTRA['helpdesk_visible_types']       = [Software::class, Appliance::class, DatabaseInstance::class];

$CFG_ZENTRA['networkport_types']            = [Computer::class, Monitor::class, NetworkEquipment::class, Peripheral::class,
...
$CFG_ZENTRA['networkport_instantiations']   = [NetworkPortEthernet::class, NetworkPortWifi::class,
...
$CFG_ZENTRA['device_types']                 = [DeviceMotherboard::class, DeviceFirmware::class, DeviceProcessor::class,
...
$CFG_ZENTRA['socket_types']                  = [Computer::class, NetworkEquipment::class,
    Peripheral::class, Phone::class, Printer::class, PassiveDCEquipment::class,
];

foreach ($CFG_ZENTRA['device_types'] as $dtype) {
    $CFG_ZENTRA['location_types'][] = 'Item_' . $dtype;
    $CFG_ZENTRA['state_types'][] = 'Item_' . $dtype;
    $CFG_ZENTRA['contract_types'][] = 'Item_' . $dtype;
}

$CFG_ZENTRA['itemdevices_types']            = [Computer::class, NetworkEquipment::class, Peripheral::class,
    Phone::class, Printer::class, Enclosure::class, PDU::class,
];

$CFG_ZENTRA['itemdevices_itemaffinity']     = [Computer::class];

$CFG_ZENTRA['itemdevicememory_types']       = [Computer::class, NetworkEquipment::class, Peripheral::class, Printer::class, Phone::class];

$CFG_ZENTRA['itemdevicepowersupply_types']  = [Computer::class, NetworkEquipment::class, Peripheral::class, Enclosure::class, Phone::class];

$CFG_ZENTRA['itemdevicenetworkcard_types']  = [Computer::class, NetworkEquipment::class, Peripheral::class, Phone::class, Printer::class];

$CFG_ZENTRA['itemdeviceharddrive_types']    = [Computer::class, Peripheral::class, NetworkEquipment::class, Printer::class, Phone::class];

$CFG_ZENTRA['itemdevicebattery_types']      = [Computer::class, Peripheral::class, Phone::class, Printer::class];

$CFG_ZENTRA['itemdevicefirmware_types']     = [Computer::class, Peripheral::class, Phone::class, NetworkEquipment::class, Printer::class];

$CFG_ZENTRA['itemdevicesimcard_types']      = [Computer::class, Peripheral::class, Phone::class, NetworkEquipment::class, Printer::class];

$CFG_ZENTRA['itemdevicegeneric_types']      = ['*'];

$CFG_ZENTRA['itemdevicepci_types']          = ['*'];

$CFG_ZENTRA['itemdevicecontrol_types']      = [Computer::class];

$CFG_ZENTRA['itemdevicedrive_types']        = [Computer::class];

$CFG_ZENTRA['itemdevicesensor_types']       = [Computer::class, Peripheral::class, Phone::class];

$CFG_ZENTRA['itemdeviceprocessor_types']    = [Computer::class, Phone::class];

$CFG_ZENTRA['itemdevicesoundcard_types']    = [Computer::class];

$CFG_ZENTRA['itemdevicegraphiccard_types']  = [Computer::class, Phone::class];

$CFG_ZENTRA['itemdevicemotherboard_types']  = [Computer::class, Phone::class];

$CFG_ZENTRA['itemdevicecamera_types']  = [Computer::class, Phone::class];

$CFG_ZENTRA['itemdevicedrive_types']  = [Computer::class, Peripheral::class];

$CFG_ZENTRA['itemdevicecontrol_types']  = [Computer::class, Peripheral::class, Phone::class, NetworkEquipment::class, Printer::class];

$CFG_ZENTRA['notificationtemplates_types']  = [CartridgeItem::class, Change::class, ConsumableItem::class,
...
$CFG_ZENTRA['union_search_type']            = [
    ReservationItem::class => 'reservation_types',
    AllAssets::class       => 'asset_types',
];

$CFG_ZENTRA['systeminformations_types']     = [AuthLDAP::class, DBConnection::class, MailCollector::class,
    Plugin::class,
];

$CFG_ZENTRA['rulecollections_types']        = [
...
$CFG_ZENTRA['planning_types']               = [ChangeTask::class, ProblemTask::class, Reminder::class,
    TicketTask::class, ProjectTask::class, PlanningExternalEvent::class,
];
$CFG_ZENTRA['planning_add_types']           = [PlanningExternalEvent::class];

// supported components send by caldav server
// - VTODO: All possible planning events of ZENTRA with a status of TODO/DONE,
//    You can generaly retrieve them in the todo tab of your caldav client
// - VJOURNAL: Zentra Reminders/Tasks with "Information" status and **not planned**, you can retrieve them in the notes tab
...
$CFG_ZENTRA['caldav_supported_components']  = ['VEVENT', 'VJOURNAL'];

$CFG_ZENTRA['globalsearch_types']           = [Computer::class, Contact::class, Contract::class,
...
$CFG_ZENTRA['number_format']  = 0;
$CFG_ZENTRA['decimal_number'] = 2;

// User Prefs fields which override $CFG_ZENTRA config
$CFG_ZENTRA['user_pref_field'] = ['backcreated', 'csv_delimiter', 'date_format',
...
$CFG_ZENTRA['lock_lockable_objects'] = [Budget::class,  Change::class, Contact::class, Contract::class, Document::class,
...
$CFG_ZENTRA['inventory_lockable_objects'] = [Asset_PeripheralAsset::class,  Item_SoftwareLicense::class,
...
$CFG_ZENTRA['printer_types'] = ['Printer'];

$CFG_ZENTRA['kb_types']              = [Budget::class, Change::class, Computer::class,
...
$CFG_ZENTRA['certificate_types']     = [Computer::class,
...
$CFG_ZENTRA['rackable_types']        = [Computer::class, Monitor::class, NetworkEquipment::class, Peripheral::class, Enclosure::class, PDU::class, PassiveDCEquipment::class];

$CFG_ZENTRA['cluster_types']        = [Computer::class, NetworkEquipment::class];

$CFG_ZENTRA['operatingsystem_types'] = [Computer::class, Monitor::class, NetworkEquipment::class, Peripheral::class, Phone::class, Printer::class];

$CFG_ZENTRA['software_types']      = $CFG_ZENTRA['operatingsystem_types'];

$CFG_ZENTRA['disk_types'] = [Computer::class, NetworkEquipment::class, Phone::class, Printer::class];

$CFG_ZENTRA['kanban_types']        = [Project::class];

$CFG_ZENTRA['domain_types']        = [Computer::class, Monitor::class, NetworkEquipment::class, Peripheral::class,
...
$CFG_ZENTRA['appliance_types']     = [Computer::class, Monitor::class, NetworkEquipment::class, Peripheral::class, Phone::class,
    Printer::class, Software::class, Appliance::class, Cluster::class, DatabaseInstance::class, Database::class,
];

$CFG_ZENTRA['appliance_relation_types'] = [Location::class, Network::class, Domain::class, ApplianceEnvironment::class];

$CFG_ZENTRA['remote_management_types'] = [Computer::class, Phone::class];

$CFG_ZENTRA['databaseinstance_types'] = [Computer::class];

$CFG_ZENTRA['agent_types'] = [Computer::class, Phone::class];

$CFG_ZENTRA['line_types'] = $CFG_ZENTRA['itemdevicesimcard_types'];

$CFG_ZENTRA['itil_types'] = [Ticket::class, Change::class, Problem::class];

$reservations_libs = ['fullcalendar', 'reservations'];

$CFG_ZENTRA['javascript'] = [
    'central'   => [
        'central' => [
            'fullcalendar',
            'planning',
    ...
    'config' => [
        'zentra\asset\assetdefinition'  => ['sortable'],
        'plugin' => [
...
foreach ($CFG_ZENTRA['reservation_types'] as $reservation_type) {
    $CFG_ZENTRA['javascript']['assets'][strtolower($reservation_type)] = array_merge(
        $CFG_ZENTRA['javascript']['assets'][strtolower($reservation_type)] ?? [],
        $reservations_libs
    );
}
...
$CFG_ZENTRA['max_time_for_count'] = 200;

/**
 * Impact itemtypes enabled by default
 */
$CFG_ZENTRA['default_impact_asset_types'] = [
 ...
 * added in ZENTRA configuration
 */
$CFG_ZENTRA['impact_asset_types'] = $CFG_ZENTRA['default_impact_asset_types'] + [
...
$CFG_ZENTRA['itemantivirus_types'] = [Computer::class, Phone::class];
$CFG_ZENTRA['itemvirtualmachines_types'] = [Computer::class];
$CFG_ZENTRA['plug_types'] = [PDU::class];

$CFG_ZENTRA['management_types'] = [
...
$CFG_ZENTRA['tools_types'] = [
    Reminder::class, RSSFeed::class,
];

$CFG_ZENTRA['admin_types'] = [
    User::class, Group::class, Entity::class, Profile::class,
];

$CFG_ZENTRA['process_types'] = [Computer::class];
$CFG_ZENTRA['environment_types'] = [Computer::class];


$CFG_ZENTRA['possible_proxy_exclusions'] = new ProxyExclusions();
