...
INSERT INTO `zentra_profilerights` (`profiles_id`, `name`, `rights`) VALUES
...
UPDATE `zentra_profiles` SET `helpdesk_item_type` = '["Computer", "PluginGenericobjectTablet"]' WHERE `id` IN (1, 6);
UPDATE `zentra_profiles` SET `helpdesk_item_type` = '["Computer", "PluginGenericobjectSmartphone", "PluginGenericobjectTablet", "Software"]' WHERE `id` IN (3, 4);

INSERT INTO `zentra_fieldunicities` (`name`, `is_recursive`, `itemtype`, `entities_id`, `fields`, `is_active`, `action_refuse`, `action_notify`, `comment`, `date_mod`, `date_creation`) VALUES
...
INSERT INTO `zentra_dropdowntranslations` (`items_id`, `itemtype`, `language`, `field`, `value`) VALUES
...
INSERT IGNORE INTO `zentra_contracts` (`id`, `name`) VALUES (4, 'Contract 4');
INSERT IGNORE INTO `zentra_contracts` (`id`, `name`) VALUES (7, 'Contract 7');
INSERT IGNORE INTO `zentra_contracts` (`id`, `name`) VALUES (12, 'Contract 12');

INSERT INTO `zentra_contracts_items` (`items_id`, `itemtype`, `contracts_id`) VALUES
