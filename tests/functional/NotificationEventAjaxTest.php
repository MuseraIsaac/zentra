...
class NotificationEventAjaxTest extends DbTestCase
{
    ...
    public function testRaise()
    {
        ...
        $queue = getAllDataFromTable('zentra_queuednotifications');
        ...
        $expected = [
            ...
            'sent_try' => 0,
            'sent_time' => null,
            'name' => '[ZENTRA #' . str_pad($ticket ->getID(), 7, '0', STR_PAD_LEFT) . '] New ticket ',
            'sender' => null,
            'sendername' => '',
  ...
  URL : {$CFG_ZENTRA['url_base']}/index.php?redirect=ticket_{$ticket->getID()} 
...
Automatically generated by ZENTRA
