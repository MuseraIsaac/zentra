...
class ZENTRATest extends ZENTRATestCase
{
    public function testMissingLanguages()
    {
        global $CFG_ZENTRA;

        $know_languages = $CFG_ZENTRA['languages'];
        $list_languages = [];
    ...
    /**
     * Verify the value of the ZENTRA_YEAR const
     *
     * @return void
     */
    public function test_ZentraYear(): void
    {
        $this->assertEquals(ZENTRA_YEAR, date('Y'));
    }
}
