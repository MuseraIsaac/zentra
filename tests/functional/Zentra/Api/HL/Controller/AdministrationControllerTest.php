...
class AdministrationControllerTest extends HLAPITestCase
{
    public function testSearchUsers()
    {
        ...
        $request = new Request('GET', '/Administration/User');
        $request->setParameter('filter', 'emails.email=like=*zentra.com');
        $this->api->call($request, function ($call) {
            /** @var \HLAPICallAsserter $call */
            $call->response
                ->isOK()
    ...
    public function testUserSearchByEmail()
    {
        $this->login();
        $request = new Request('GET', '/Administration/User');
        $request->setParameter('filter', 'emails.email==' . TU_USER . '@zentra.com');
        $this->api->call($request, function ($call) {
            /** @var \HLAPICallAsserter $call */
            $call->response
                ->isOK()
    ...
    public function testGetMySpecificEmail()
    {
        ...
        $this->login();
        // Get ID of TU_USER email with email = TU_USER . '@zentra.com'
        $email_id = $DB->request([
            'SELECT' => ['id'],
        ...
        $this->api->call(new Request('GET', "/Administration/User/me/email/$email_id"), function ($call) {
            ...
            $call->response
                ...
                ->jsonContent(function ($content) {
                    ...
                    $this->assertEquals(TU_USER . '@zentra.com', $content['email']);
                });
        });
    ...
    public function testGetMyPicture()
    {
        ...
        $this->api->call(new Request('GET', '/Administration/User/me/picture'), function ($call) {
            ...
            $call->response
                ...
                ->content(function ($content) {
                    $this->assertEquals(file_get_contents(ZENTRA_ROOT . '/public/pics/picture.png'), $content);
                });
        });
        $this->addCustomUserPicture($_SESSION['zentraID'], ZENTRA_ROOT . '/tests/fixtures/uploads/foo.png');
        ...
        $this->api->call(new Request('GET', '/Administration/User/me/picture'), function ($call) {
            ...
            $call->response
                ->isOK()
                ->content(function ($content) {
                    $this->assertEquals(file_get_contents(ZENTRA_ROOT . '/tests/fixtures/uploads/foo.png'), $content);
                });
        });
    }
    ...
    public function testSearchEventLogs()
    {
        ...
        $_SESSION['zentraactiveprofile']['system_logs'] = 0;
