...
class CoreControllerTest extends HLAPITestCase
{
    ...
    public function testTransferEntity()
    {
        ...
        $request = new Request('POST', '/Transfer', [
            ...
            'ZENTRA-Entity' => $root_entity,
            'ZENTRA-Entity-Recursive' => 'true',
    ...
    public function testOAuthPasswordGrant()
    {
        ...
        $auth_data = [
            ...
            'client_secret' => (new \ZENTRAKey())->decrypt($client_data['secret']),
            'username' => TU_USER,
            'password' => TU_PASS,
            'scope' => '',
        ];
    ...
    public function testOAuthPasswordGrantHeader()
    {
        ...
        $request = new Request('POST', '/Token', [
            'Content-Type' => 'application/json',
            'Authorization' => 'Basic ' . base64_encode($client_data['identifier'] . ':' . (new \ZENTRAKey())->decrypt($client_data['secret'])),
