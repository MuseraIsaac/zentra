...
class CustomAssetControllerTest extends HLAPITestCase
{
    ...
    public function testCRUDNoRights()
    {
        $this->api->autoTestCRUDNoRights(
            ...
            itemtype: 'Zentra\\CustomAsset\\Test01Asset',
            items_id: getItemByTypeName('Zentra\\CustomAsset\\Test01Asset', 'TestA', true)
        );
    }

    public function testAssignableRights()
    {
        $this->api->autoTestAssignableItemRights('/Assets/Custom/Test01', 'Zentra\\CustomAsset\\Test01Asset');
    }
    ...
    public function testAssetModelAndTypeProperties()
    {
        ...
        $asset_1 = getItemByTypeName('Zentra\\CustomAsset\\Test01Asset', 'TestB', true);
        $model_1 = getItemByTypeName('Zentra\\CustomAsset\\Test01AssetModel', 'Test01Model01', true);
        $type_1 = getItemByTypeName('Zentra\\CustomAsset\\Test01AssetType', 'Test01Type01', true);
