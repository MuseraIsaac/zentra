...
GRAPHQL);
    ...
    public function testGetDirectlyWithoutRight()
    {
        ...
        $this->assertTrue($DB->insert('zentra_tickets', [
            'name' => __FUNCTION__,
        ...
        $_SESSION['zentra_use_mode'] = 2;

        // Can see no tickets
        $_SESSION['zentraactiveprofile']['ticket'] = 0;
    ...
    public function testGetTicketIndirectlyWithoutRight()
    {
        ...
        $this->assertTrue($DB->update('zentra_entities', [
        ...
        // Can see no entities
        $_SESSION['zentraactiveprofile']['entity'] = 0;
