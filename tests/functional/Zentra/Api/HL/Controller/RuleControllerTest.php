...
class RuleControllerTest extends HLAPITestCase
{
    ...
    public function testAccess()
    {
        ...
        $rule_ticket_right = $_SESSION['zentraactiveprofile']['rule_ticket'];
        $_SESSION['zentraactiveprofile']['rule_ticket'] = 0;
        ...
        $_SESSION['zentraactiveprofile']['rule_ticket'] = $rule_ticket_right;
