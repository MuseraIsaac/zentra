                ...
                ->jsonContent(function ($content) use ($dataset) {
                    ...
                    foreach ($content as $type) {
                        if ($type['itemtype'] === 'RSSFeed') {
                            $dataset = [
                                ['url' => $CFG_ZENTRA['url_base'] . '/api.php/v2/fakerss'],
                                ['url' => $CFG_ZENTRA['url_base'] . '/api.php/v2/fakerss2'],
                                ['url' => $CFG_ZENTRA['url_base'] . '/api.php/v2/fakerss3'],
                            ];
                        }
            ...
            $call->response
                ...
                ->jsonContent(function ($content) {
                    ...
                    foreach ($content as $type) {
                        $create_params = [];
                        if ($type['itemtype'] === 'RSSFeed') {
                            $create_params['url'] = $CFG_ZENTRA['url_base'] . '/api.php/v2/fakerss';
                        }
            ...
            $call->response
                ...
                ->jsonContent(function ($content) {
                    ...
                    foreach ($content as $type) {
                        ...
                        if ($type['itemtype'] === 'RSSFeed') {
                            $create_request->setParameter('url', $CFG_ZENTRA['url_base'] . '/api.php/v2/fakerss');
                        }
                        $new_location = null;
                        $new_items_id = null;
