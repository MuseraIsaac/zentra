...
namespace tests\units\Zentra\Api\HL\RSQL;

use Zentra\Api\HL\Doc\Schema;
use Zentra\Api\HL\RSQL\Error;
use Zentra\Api\HL\RSQL\Parser;
use Zentra\Api\HL\RSQL\RSQLException;
use Zentra\Api\HL\Search;
use Zentra\Tests\ZENTRATestCase;
use PHPUnit\Framework\Attributes\DataProvider;

class ParserTest extends ZENTRATestCase
{
    ...
    public static function parseProvider()
    {
        return [
            [
                [[5, 'id'], [6, '=='], [7, '20']], /** Tokens. First element is the token type. See T_* consts in {@link \Zentra\Api\HL\RSQL\Lexer} */
                "(`_`.`id` = '20')",
            ],
            [
                [
