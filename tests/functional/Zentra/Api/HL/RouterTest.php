...
namespace tests\units\Zentra\Api\HL;
...
class RouterTest extends ZENTRATestCase
{
    ...
    public function testRoutingByVersion()
    {
        ...
        $this->assertNotEquals('/{req}', $router->match(new Request('GET', '/version500', ['ZENTRA-API-Version' => '50.0']))->getRoutePath());
        // 50 is requesting 50.X.X or earlier
        $this->assertNotEquals('/{req}', $router->match(new Request('GET', '/version500', ['ZENTRA-API-Version' => '50']))->getRoutePath());
        // 50.1 is requesting 50.1.X or earlier
        $this->assertNotEquals('/{req}', $router->match(new Request('GET', '/version500', ['ZENTRA-API-Version' => '50.1']))->getRoutePath());
        $this->assertNotEquals('/{req}', $router->match(new Request('GET', '/version500', ['ZENTRA-API-Version' => '51']))->getRoutePath());

        $this->assertEquals('/{req}', $router->match(new Request('GET', '/version501', ['ZENTRA-API-Version' => '50.0']))->getRoutePath());
        $this->assertNotEquals('/{req}', $router->match(new Request('GET', '/version501', ['ZENTRA-API-Version' => '50.1']))->getRoutePath());
        $this->assertNotEquals('/{req}', $router->match(new Request('GET', '/version501', ['ZENTRA-API-Version' => '50']))->getRoutePath());

        $this->assertEquals('/{req}', $router->match(new Request('GET', '/version510', ['ZENTRA-API-Version' => '50.0']))->getRoutePath());
        $this->assertEquals('/{req}', $router->match(new Request('GET', '/version510', ['ZENTRA-API-Version' => '50.1']))->getRoutePath());
        $this->assertNotEquals('/{req}', $router->match(new Request('GET', '/version510', ['ZENTRA-API-Version' => '51']))->getRoutePath());
        $this->assertEquals('/{req}', $router->match(new Request('GET', '/version510', ['ZENTRA-API-Version' => '50']))->getRoutePath());
    }
...
class TestRouter extends Router
{
    ...
    public static function getAPIVersions(): array
    {
        ...
        $versions[] = [
            'api_version' => '50',
            'version' => '50.0.0',
            'endpoint' => $CFG_ZENTRA['url_base'] . '/api.php/v50',
        ];
        $versions[] = [
            'api_version' => '50',
            'version' => '50.1.0',
            'endpoint' => $CFG_ZENTRA['url_base'] . '/api.php/v50.1',
        ];
        $versions[] = [
            'api_version' => '50',
            'version' => '50.1.1',
            'endpoint' => $CFG_ZENTRA['url_base'] . '/api.php/v50.1.1',
        ];
        $versions[] = [
            'api_version' => '50',
            'version' => '50.1.2',
            'endpoint' => $CFG_ZENTRA['url_base'] . '/api.php/v50.1.2',
        ];
        $versions[] = [
            'api_version' => '50',
            'version' => '50.2.0',
            'endpoint' => $CFG_ZENTRA['url_base'] . '/api.php/v50.2',
        ];
        $versions[] = [
            'api_version' => '51',
            'version' => '51.0.0',
            'endpoint' => $CFG_ZENTRA['url_base'] . '/api.php/v51',
        ];
