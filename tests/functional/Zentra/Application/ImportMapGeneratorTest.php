...
namespace tests\units\Zentra\Application;
 ...
 */
class ImportMapGeneratorTest extends ZENTRATestCase
{
    /**
     * Root URL for the import map
     */
    private const ROOT_URL = '/zentra';
    ...
    {
        return vfsStream::setup('zentra', null, [
            'js' => [
                'modules' => [
                    'Forms' => [
                        'ZentraFormConditionEditorController.js' => '// Some JS content 1',
                        'ZentraFormDestinationAutoConfigController.js' => '// Some JS content 2',
                    ],
                    'Utils' => [
    ...
    public function testGenerate()
    {
        ...
        $generator = $this->createMockGenerator(vfsStream::url('zentra'));
        ...
        $this->assertArrayHasKey('/js/modules/Forms/ZentraFormConditionEditorController.js', $import_map['imports']);
        $this->assertArrayHasKey('/js/modules/Forms/ZentraFormDestinationAutoConfigController.js', $import_map['imports']);
        ...
        $this->assertStringContainsString(
            self::ROOT_URL . '/js/modules/Forms/ZentraFormConditionEditorController.js?v=',
            $import_map['imports']['/js/modules/Forms/ZentraFormConditionEditorController.js']
        );
        $this->assertStringContainsString(
    ...
    public function testVersionParameterChangesWhenFileContentChanges()
    {
        ...
        // Test file path
        $file_path = vfsStream::url('zentra/js/modules/TestModule.js');
