...
namespace tests\units\Zentra\Application\View\Extension;
...
class FrontEndAssetsExtensionTest extends ZENTRATestCase
{
    public static function jsPathProvider(): iterable
    {
        global $CFG_ZENTRA;

        $v_default = FrontEnd::getVersionCacheKey(ZENTRA_VERSION);
    ...
    {
        $_SESSION['zentra_use_mode'] = $debug_mode ? \Session::DEBUG_MODE : \Session::NORMAL_MODE;

        // Only the ZENTRA structure can be mocked, plugins rely on fixtures.
        vfsStream::setup(
            'zentra',
            null,
            [
        ...
        $ext = new FrontEndAssetsExtension(vfsStream::url('zentra'));
