...
class AllowedInGlobalSearchCapacityTest extends DbTestCase
{
    public function testCapacityActivation(): void
    {
        ...
        foreach ($has_capacity_mapping as $classname => $has_capacity) {
            ...
            if ($has_capacity) {
                $this->assertContains($classname, $CFG_ZENTRA['globalsearch_types']);
            } else {
                $this->assertNotContains($classname, $CFG_ZENTRA['globalsearch_types']);
            }
        }
    }
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->assertContains($classname_1, $CFG_ZENTRA['globalsearch_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['globalsearch_types']);
        ...
        $this->assertEquals(1, countElementsInTable(Log::getTable(), $item_1_logs_criteria)); // create
        $this->assertNotContains($classname_1, $CFG_ZENTRA['globalsearch_types']);
