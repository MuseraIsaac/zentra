...
class HasCertificatesCapacityTest extends DbTestCase
{
    ...
    public function testCapacityActivation(): void
    {
        ...
        foreach ($has_certificates_mapping as $classname => $has_certificates) {
            ...
            if ($has_certificates) {
                $this->assertContains($classname, $CFG_ZENTRA['certificate_types']);
                $this->assertContains($classname, Certificate::getTypes());
            } else {
                $this->assertNotContains($classname, $CFG_ZENTRA['certificate_types']);
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->assertContains($classname_1, $CFG_ZENTRA['certificate_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['certificate_types']);
        ...
        $this->assertNotContains($classname_1, $CFG_ZENTRA['certificate_types']);
