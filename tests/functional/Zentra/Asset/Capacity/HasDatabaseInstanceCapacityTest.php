...
use Zentra\Asset\Capacity\HasDatabaseInstanceCapacity;
...
class HasDatabaseInstanceCapacityTest extends DbTestCase
{
    ...
    public function testCapacityActivation(): void
    {
        ...
        foreach ($has_capacity_mapping as $classname => $has_capacity) {
            ...
            if ($has_capacity) {
                $this->assertContains($classname, $CFG_ZENTRA['databaseinstance_types']);
            } else {
                $this->assertNotContains($classname, $CFG_ZENTRA['databaseinstance_types']);
            }
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->assertContains($classname_1, $CFG_ZENTRA['databaseinstance_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['databaseinstance_types']);
        ...
        $this->assertNotContains($classname_1, $CFG_ZENTRA['databaseinstance_types']);
