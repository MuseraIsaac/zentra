...
class HasDocumentsCapacityTest extends DbTestCase
{
    ...
    public function testCapacityActivation(): void
    {
        ...
        foreach ($has_documents_mapping as $classname => $has_documents) {
            ...
            if ($has_documents) {
                $this->assertContains($classname, $CFG_ZENTRA['document_types']);
                $this->assertTrue(Document::canApplyOn($classname));
                $this->assertContains($classname, Document::getItemtypesThatCanHave());
            } else {
                $this->assertNotContains($classname, $CFG_ZENTRA['document_types']);
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->assertContains($classname_1, $CFG_ZENTRA['document_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['document_types']);
        ...
        $this->assertNotContains($classname_1, $CFG_ZENTRA['document_types']);
