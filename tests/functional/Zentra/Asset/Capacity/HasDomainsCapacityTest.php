...
class HasDomainsCapacityTest extends DbTestCase
{
    ...
    public function testCapacityActivation(): void
    {
        ...
        foreach ($has_domains_mapping as $classname => $has_domains) {
            ...
            if ($has_domains) {
                $this->assertContains($classname, $CFG_ZENTRA['domain_types']);
                $this->assertContains($classname, Domain::getTypes());
            } else {
                $this->assertNotContains($classname, $CFG_ZENTRA['domain_types']);
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->assertContains($classname_1, $CFG_ZENTRA['domain_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['domain_types']);
        ...
        $this->assertNotContains($classname_1, $CFG_ZENTRA['domain_types']);
