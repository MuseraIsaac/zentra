...
use Zentra\Asset\Capacity\HasImpactCapacity;
...
class HasImpactCapacityTest extends DbTestCase
{
    public function testCapacityActivation(): void
    {
        ...
        foreach ($has_impact_mapping as $classname => $has_impact) {
            ...
            if ($has_impact) {
                $this->assertArrayHasKey($classname, $CFG_ZENTRA['impact_asset_types']);
                $this->assertContains($classname, $enabled_impact_types);
            } else {
                $this->assertArrayNotHasKey($classname, $CFG_ZENTRA['impact_asset_types']);
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->assertArrayHasKey($classname_1, $CFG_ZENTRA['impact_asset_types']);
        $this->assertArrayHasKey($classname_2, $CFG_ZENTRA['impact_asset_types']);
        ...
        $this->assertArrayNotHasKey($classname_1, $CFG_ZENTRA['impact_asset_types']);
