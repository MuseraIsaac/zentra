...
class HasInfocomCapacityTest extends DbTestCase
{
    ...
    public function testCapacityActivation(): void
    {
        ...
        foreach ($has_infocom_mapping as $classname => $has_infocom) {
            ...
            if ($has_infocom) {
                $this->assertContains($classname, $CFG_ZENTRA['infocom_types']);
                $this->assertTrue(Infocom::canApplyOn($classname));
                $this->assertContains($classname, Infocom::getItemtypesThatCanHave());
            } else {
                $this->assertNotContains($classname, $CFG_ZENTRA['infocom_types']);
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->assertContains($classname_1, $CFG_ZENTRA['infocom_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['infocom_types']);
        ...
        $this->assertNotContains($classname_1, $CFG_ZENTRA['infocom_types']);
