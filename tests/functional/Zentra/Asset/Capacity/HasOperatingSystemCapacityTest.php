...
use Zentra\Asset\Capacity\HasOperatingSystemCapacity;
...
class HasOperatingSystemCapacityTest extends DbTestCase
{
    ...
    public function testConfigRegistration(): void
    {
        ...
        // registered in $CFG_ZENTRA["operatingsystem_types"]
        $this->assertNotContains($class, $CFG_ZENTRA["operatingsystem_types"]);
        ...
        $this->assertContains($class, $CFG_ZENTRA["operatingsystem_types"]);
