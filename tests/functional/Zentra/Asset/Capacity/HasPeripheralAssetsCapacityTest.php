...
class HasPeripheralAssetsCapacityTest extends DbTestCase
{
    public function testCapacityActivation(): void
    {
        ...
        foreach ($has_capacity_mapping as $classname => $has_capacity) {
            ...
            if ($has_capacity) {
                $this->assertContains($classname, $CFG_ZENTRA['peripheralhost_types']);
                $this->assertContains($classname, Asset_PeripheralAsset::getPeripheralHostItemtypes());
            } else {
                $this->assertNotContains($classname, $CFG_ZENTRA['peripheralhost_types']);
            ...
            if ($has_capacity) {
                $this->assertArrayHasKey('Zentra\\Asset\\Asset_PeripheralAsset$1', $item->defineAllTabs());
            } else {
                $this->assertArrayNotHasKey('Zentra\\Asset\\Asset_PeripheralAsset$1', $item->defineAllTabs());
            }
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->assertContains($classname_1, $CFG_ZENTRA['peripheralhost_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['peripheralhost_types']);
        ...
        $this->assertNotContains($classname_1, $CFG_ZENTRA['peripheralhost_types']);
