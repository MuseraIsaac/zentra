...
use Zentra\Asset\Capacity\HasPlugCapacity;
...
class HasPlugCapacityTest extends DbTestCase
{
    ...
    public function testCapacityActivation(): void
    {
        ...
        foreach ($has_capacity_mapping as $classname => $has_capacity) {
            ...
            if ($has_capacity) {
                $this->assertContains($classname, $CFG_ZENTRA['plug_types']);
            } else {
                $this->assertNotContains($classname, $CFG_ZENTRA['plug_types']);
            }
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->assertContains($classname_1, $CFG_ZENTRA['plug_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['plug_types']);
        ...
        $this->assertNotContains($classname_1, $CFG_ZENTRA['plug_types']);
