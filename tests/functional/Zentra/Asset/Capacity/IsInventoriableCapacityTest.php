...
namespace tests\units\Zentra\Asset\Capacity;
...
use Zentra\Inventory\MainAsset\GenericAsset;
...
class IsInventoriableCapacityTest extends DbTestCase
{
    ...
    public function testCapacityActivation(): void
    {
        ...
        foreach ($has_capacity_mapping as $classname => $has_capacity) {
            ...
            if ($has_capacity) {
                $this->assertContains($classname, $CFG_ZENTRA['inventory_types']);
                $this->assertContains($classname, $CFG_ZENTRA['agent_types']);
                $this->assertContains($classname, $CFG_ZENTRA['environment_types']);
                $this->assertContains($classname, $CFG_ZENTRA['process_types']);
            } else {
                $this->assertNotContains($classname, $CFG_ZENTRA['inventory_types']);
                $this->assertNotContains($classname, $CFG_ZENTRA['agent_types']);
                $this->assertNotContains($classname, $CFG_ZENTRA['environment_types']);
                $this->assertNotContains($classname, $CFG_ZENTRA['process_types']);
            }
        }
    }
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->assertContains($classname_1, $CFG_ZENTRA['inventory_types']);
        $this->assertContains($classname_1, $CFG_ZENTRA['agent_types']);
        $this->assertContains($classname_1, $CFG_ZENTRA['environment_types']);
        $this->assertContains($classname_1, $CFG_ZENTRA['process_types']);
        $this->assertNotContains($classname_1, $CFG_ZENTRA['printer_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['inventory_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['agent_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['environment_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['process_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['printer_types']);
        ...
        $this->assertNotContains($classname_1, $CFG_ZENTRA['inventory_types']);
        $this->assertNotContains($classname_1, $CFG_ZENTRA['agent_types']);
        $this->assertNotContains($classname_1, $CFG_ZENTRA['environment_types']);
        $this->assertNotContains($classname_1, $CFG_ZENTRA['process_types']);
