...
class IsProjectAssetCapacityTest extends DbTestCase
{
    ...
    public function testCapacityActivation(): void
    {
        ...
        foreach ($is_project_asset_mapping as $classname => $is_project_asset) {
            ...
            if ($is_project_asset) {
                $this->assertContains($classname, $CFG_ZENTRA['project_asset_types']);
            } else {
                $this->assertNotContains($classname, $CFG_ZENTRA['project_asset_types']);
            }
    ...
    public function testCapacityDeactivation(): void
    {
        ...
        $this->assertContains($classname_1, $CFG_ZENTRA['project_asset_types']);
        $this->assertContains($classname_2, $CFG_ZENTRA['project_asset_types']);
        ...
        $this->assertNotContains($classname_1, $CFG_ZENTRA['project_asset_types']);
