...
class CustomFieldDefinitionTest extends DbTestCase
{
    ...
    public function testGetSearchOption()
    {
        ...
        $this->assertEquals("COALESCE(JSON_UNQUOTE(JSON_EXTRACT(`zentra_assets_assets`.`custom_fields`, '$.\\\"{$field_id}\\\"')), 'default')", (string) $opt['computation']);
        ...
        $this->assertEquals("COALESCE(JSON_UNQUOTE(JSON_EXTRACT(`zentra_assets_assets`.`custom_fields`, '$.\\\"{$field_id}\\\"')), 'default text')", (string) $opt['computation']);
        ...
        $this->assertEquals("COALESCE(JSON_UNQUOTE(JSON_EXTRACT(`zentra_assets_assets`.`custom_fields`, '$.\\\"{$field_id}\\\"')), '420')", (string) $opt['computation']);
        ...
        $this->assertEquals("COALESCE(JSON_UNQUOTE(JSON_EXTRACT(`zentra_assets_assets`.`custom_fields`, '$.\\\"{$field_id}\\\"')), '2021-01-01')", (string) $opt['computation']);
        ...
        $this->assertEquals("COALESCE(JSON_UNQUOTE(JSON_EXTRACT(`zentra_assets_assets`.`custom_fields`, '$.\\\"{$field_id}\\\"')), '2021-01-01 03:25:15')", (string) $opt['computation']);
        ...
        $custom_field_definition_8 = $this->createItem(CustomFieldDefinition::class, [
            ...
            'label' => 'Test url',
            'type' => URLType::class,
            'default_value' => 'https://zentra-project.org',
        ]);
        ...
        $this->assertEquals("COALESCE(JSON_UNQUOTE(JSON_EXTRACT(`zentra_assets_assets`.`custom_fields`, '$.\\\"{$field_id}\\\"')), 'https://zentra-project.org')", (string) $opt['computation']);
        $this->assertEquals('string', $opt['datatype']);
        ...
        $this->assertEquals("COALESCE(JSON_UNQUOTE(JSON_EXTRACT(`zentra_assets_assets`.`custom_fields`, '$.\\\"{$field_id}\\\"')), '1')", (string) $opt['computation']);
            ...
            'SELECT' => [
                QueryFunction::jsonUnquote(
                    expression: QueryFunction::jsonExtract([
                        'zentra_assets_assets.custom_fields',
    ...
    public function testSearchDropdownField(): void
    {
        ...
        $opts = SearchOption::getOptionsForItemtype('Zentra\\CustomAsset\\Test01Asset');
        ...
        $this->createItem('Zentra\\CustomAsset\\Test01Asset', [
            'entities_id' => $this->getTestRootEntity(true),
            'name' => __FUNCTION__,
            'custom_customtagsingle' => getItemByTypeName('Zentra\\CustomDropdown\\CustomTagDropdown', 'Tag01', true),
            'custom_customtagmulti' => [
                getItemByTypeName('Zentra\\CustomDropdown\\CustomTagDropdown', 'Tag01', true),
                getItemByTypeName('Zentra\\CustomDropdown\\CustomTagDropdown', 'Tag02', true),
            ],
        ], ['custom_customtagsingle', 'custom_customtagmulti']);

        $data = SearchEngine::getData('Zentra\\CustomAsset\\Test01Asset', [
            'criteria' => [
                [
                    'link' => 'AND',
                    'field' => 'name',
        ...
        $this->assertEquals(
            'Tag01',
            $row['ITEM_Zentra\\CustomAsset\\Test01Asset_' . $single_dropdown_opt]
        );
        $this->assertEquals(
            'Tag01$#$1$$##$$Tag02$#$2',
            $row['ITEM_Zentra\\CustomAsset\\Test01Asset_' . $multiple_dropdown_opt]
        );
    }
}
