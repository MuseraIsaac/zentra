...
namespace tests\units\Zentra\Console;

use Error;
use Zentra\Console\CommandLoader;
use Zentra\Tests\ZENTRATestCase;
use org\bovigo\vfs\vfsStream;

class CommandLoaderTest extends ZENTRATestCase
{
...
<?php
namespace ZentraPlugin\\Awesome;
...
<?php
namespace ZentraPlugin\\Awesome\\Console;
...
<?php
namespace ZentraPlugin\\Random\\Console;
...
PHP,
        ...
        $core_names_to_class = [
            ...
            'test'             => 'Zentra\\Console\\TestCommand',
            'tools:debug'      => 'Zentra\\Tools\\Command\\DebugCommand',
        ];

        $plugins_names_to_class = [
            'plugins:awesome:update'     => 'PluginAwesomeUpdateCommand',
            'plugins:awesome:namespaced' => 'ZentraPlugin\\Awesome\\NamespacedCommand',
            'plugins:awesome:another'    => 'ZentraPlugin\\Awesome\\Console\\AnotherCommand',
            'plugins:awesome:psr4'       => 'PluginAwesomePsr4Command',
            'plugins:awesome:yetanother' => 'ZentraPlugin\\Awesome\\Console\\YetAnotherCommand',
            'plugins:random:random'      => 'PluginRandomRandomCommand',
            'plugins:random:check'       => 'ZentraPlugin\\Random\\CheckCommand',
            'plugins:random:foo'         => 'ZentraPlugin\\Random\\Console\\FooCommand',
        ];
        ...
        $plugin = new class extends \Plugin {
            ...
            public static function getPhpDir(string $plugin_key = "", $full = true)
            {
                return match ($plugin_key) {
                    'awesome' => vfsStream::url('zentra/plugins/awesome'),
                    'random' => vfsStream::url('zentra/tests/fixtures/plugins/random'),
                };
            }
        };
        ...
        $command_loader = new CommandLoader(true, vfsStream::url('zentra'), $plugin);
        ...
        $errors = [];
        $command_loader = new CommandLoader(false, vfsStream::url('zentra'), $plugin);
