...
namespace tests\units\Zentra\Controller;

use Zentra\Controller\ErrorController;
...
class ErrorControllerTest extends DbTestCase
{
    ...
    public function testErrorPageRendering(
        ...
        $this->assertStringContainsString(sprintf('<title>%s - ZENTRA</title>', \htmlspecialchars($expected_title)), $content);
