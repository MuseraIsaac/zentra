...
namespace tests\units\Zentra\Controller\Form;

use Zentra\Controller\Form\QuestionActorsDropdownController;
...
final class QuestionActorsDropdownControllerTest extends DbTestCase
{
    ...
    {
        $default_dataset = [
            // Default users: _test_user, zentra, normal, post-only, tech, Smith John
            'users' => [],
