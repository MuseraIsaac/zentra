...
class DashboardTest extends DbTestCase
{
    ...
    {
        $reflector = new \ReflectionClass("Zentra\Dashboard\Dashboard");
    ...
    public function testCheckRights()
    {
        ...
        $_SESSION['zentraactiveprofile'] = ['id' => 1];
        ...
        $_SESSION['zentraactiveentities'] = [];
        $_SESSION['zentraactiveprofile'] = ['id' => 3];
        $this->assertTrue(Dashboard::checkRights($rights));
