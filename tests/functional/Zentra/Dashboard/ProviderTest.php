...
use Zentra\CustomAsset\Test01Asset;
use Zentra\CustomAsset\Test01AssetType;
use Zentra\Dashboard\Provider;
...
class ProviderTest extends DbTestCase
{
    ...
    public function testBigNumber(\CommonDBTM $item)
    {
        ...
        $data = [
            ...
            call_user_func(['\\Zentra\\Dashboard\\Provider', "bigNumber$itemtype"]),
        ];
