...
class DropdownDefinitionManagerTest extends DbTestCase
{
    public function testLoadConcreteClass(): void
    {
        ...
        for ($i = 0; $i < 5; $i++) {
            ...
            $mapping['Zentra\\CustomDropdown\\' . $system_name . 'Dropdown'] = $this->initDropdownDefinition($system_name);
        }
    ...
    public function testAutoloader(): void
    {
        ...
        $this->assertTrue(\class_exists('Zentra\CustomDropdown\Iso3Country_CodeDropdown'));
    }
