...
namespace tests\units\Zentra\Dropdown;
...
class DropdownDefinitionTest extends DbTestCase
{
    ...
    public function testDelete()
    {
        ...
        $this->assertGreaterThan(
            0,
            getAllDataFromTable('zentra_displaypreferences', ['itemtype' => $classname])
        );
        ...
        $this->assertCount(
            0,
            getAllDataFromTable('zentra_dropdowns_dropdowns', ['dropdowns_dropdowndefinitions_id' => $definition->getID()])
        );
    ...
    {
        $actual_profilerights = getAllDataFromTable('zentra_profilerights', ['name' => $rightname]);
