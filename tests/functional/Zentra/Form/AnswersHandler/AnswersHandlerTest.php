...
namespace tests\units\Zentra\Form\AnswersHandler;

use CommonITILObject;
use Computer;
use Entity;
use Zentra\Form\Answer;
...
use Zentra\Form\QuestionType\QuestionTypeUserDevicesConfig;
...
class AnswersHandlerTest extends DbTestCase
{
    ...
    public function testSaveAnswers(): void
    {
        ...
        $builder
            ...
            ->addQuestion("Thoughts about ZENTRA", QuestionTypeLongText::class)
        ;
        ...
        $thoughts_question = Question::getById(
            self::getQuestionId($form_1, "Thoughts about ZENTRA")
        );
        ...
        $this->validateAnswers(
            ...
            answers: [
                ...
                self::getQuestionId($form_1, "Thoughts about ZENTRA") => "I love ZENTRA!!!",
            ],
            expected_set: [
                ...
                'answers'        => json_encode([
                    ...
                    new Answer($thoughts_question, "I love ZENTRA!!!"),
                ]),
            ]
        );
        ...
        $this->validateAnswers(
            ...
            answers: [
                ...
                self::getQuestionId($form_1, "Thoughts about ZENTRA") => "ZENTRA is incredible",
            ],
            expected_set: [
                'forms_forms_id' => $form_1->getID(),
                'users_id'       => $users_id,
                ...
                'answers'        => json_encode([
                    ...
                    new Answer($thoughts_question, "ZENTRA is incredible"),
                ]),
            ]
        );
        ...
        $this->validateAnswers(
            ...
            users_id: $users_id,
            answers: [
                self::getQuestionId($form_2, "Contact email") => "zentra@teclib.com",
            ],
            expected_set: [
                ...
                'index'          => 1,
                'answers'        => json_encode([
                    new Answer($contact_email_question, "zentra@teclib.com"),
                ]),
            ]
        );
    }
