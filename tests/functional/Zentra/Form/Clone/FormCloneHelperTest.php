...
namespace tests\units\Zentra\Form\Clone;
...
final class FormCloneHelperTest extends DbTestCase
{
    ...
    public function testIdsInFormTagsAreUpdatedWhenCloning(): void
    {
        ...
        $this->assertStringContainsString(
            "data-form-tag-value=\"{$clone->getID()}\" data-form-tag-provider=\"Zentra\Form\Tag\FormTagProvider\"",
            $cloned_destination->getConfig()[TitleField::getKey()]['value'],
        );
        $this->assertStringContainsString(
            "data-form-tag-value=\"{$cloned_section->getID()}\" data-form-tag-provider=\"Zentra\Form\Tag\SectionTagProvider\"",
            $cloned_destination->getConfig()[ContentField::getKey()]['value'],
        );
        $this->assertStringContainsString(
            "data-form-tag-value=\"{$cloned_question->getID()}\" data-form-tag-provider=\"Zentra\Form\Tag\QuestionTagProvider\"",
            $cloned_destination->getConfig()[ContentField::getKey()]['value'],
        );
        $this->assertStringContainsString(
            "data-form-tag-value=\"{$cloned_question->getID()}\" data-form-tag-provider=\"Zentra\Form\Tag\AnswerTagProvider\"",
            $cloned_destination->getConfig()[ContentField::getKey()]['value'],
        );
        $this->assertStringContainsString(
            "data-form-tag-value=\"{$cloned_comment_1->getID()}\" data-form-tag-provider=\"Zentra\Form\Tag\CommentTitleTagProvider\"",
            $cloned_destination->getConfig()[ContentField::getKey()]['value'],
        );
        $this->assertStringContainsString(
            "data-form-tag-value=\"{$cloned_comment_2->getID()}\" data-form-tag-provider=\"Zentra\Form\Tag\CommentTitleTagProvider\"",
            $cloned_destination->getConfig()[ContentField::getKey()]['value'],
        );
        $this->assertStringContainsString(
            "data-form-tag-value=\"{$cloned_comment_1->getID()}\" data-form-tag-provider=\"Zentra\Form\Tag\CommentDescriptionTagProvider\"",
            $cloned_destination->getConfig()[ContentField::getKey()]['value'],
        );
        $this->assertStringContainsString(
            "data-form-tag-value=\"{$cloned_comment_2->getID()}\" data-form-tag-provider=\"Zentra\Form\Tag\CommentDescriptionTagProvider\"",
            $cloned_destination->getConfig()[ContentField::getKey()]['value'],
        );
    }
