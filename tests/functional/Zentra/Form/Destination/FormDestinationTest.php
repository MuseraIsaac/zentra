...
namespace tests\units\Zentra\Form\Destination;
...
final class FormDestinationTest extends DbTestCase
{
    ...
    public function testDisplayTabContentForItemWithNotExistingItemType(): void
    {
        ...
        $DB->update(FormDestination::getTable(), [
            'itemtype' => 'ZentraPlugin\NotExistingPlugin\Form\ComputerDestination',
        ], ['id' => $destination->getID()]);

        $destination->getFromDB($destination->getID());
        $this->assertEquals('ZentraPlugin\NotExistingPlugin\Form\ComputerDestination', $destination->fields['itemtype']);
