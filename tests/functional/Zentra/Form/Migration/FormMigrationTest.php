...
use Zentra\Form\Migration\TypesConversionMapper;
use Zentra\Form\Question;
use Zentra\Form\QuestionType\AbstractQuestionTypeSelectable;
...
use Zentra\Form\QuestionType\QuestionTypeDateTimeExtraDataConfig;
...
use ZentraPlugin\Tester\Form\QuestionTypeIpConverter;
use Group;
use ITILCategory;
use Location;
use LogicException;
...
final class FormMigrationTest extends DbTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $queries = $DB->getQueriesFromFile(sprintf('%s/tests/fixtures/genericobject-migration/genericobject-db.sql', ZENTRA_ROOT));
        foreach ($queries as $query) {
            $DB->doQuery($query);
        }
    }
    ...
    public static function tearDownAfterClass(): void
    {
        ...
        $tables = $DB->listTables('zentra\_plugin\_genericobject\_%');
        foreach ($tables as $table) {
            $DB->dropTable($table['TABLE_NAME']);
        }
    ...
    public static function provideFormMigrationQuestions(): iterable
    {
        ...
        yield 'ZENTRA Object question type' => [
            [
                Section::getForeignKeyField() => $section_id,
                'name'                        => 'Test form migration for questions - Zentra Object',
    ...
    public function testFormMigrationQuestionDropdownItemWithInvalidItemtype(): void
    {
        ...
        // Create a form
        $this->assertTrue($DB->insert('zentra_plugin_formcreator_forms', ['name' => $form_name]));
        $form_id = $DB->insertId();
    ...
    public function testUnkownQuestionTypesAreIgnored(): void
    {
        ...
        $DB->insert('zentra_plugin_formcreator_questions', [
        ...
        $DB->insert('zentra_plugin_formcreator_questionregexes', [
    ...
    public function testValidationRequestCanBeImported(): void
    {
        ...
        $DB->insert('zentra_plugin_formcreator_targettickets', [
        ...
        $DB->insert('zentra_plugin_formcreator_targets_actors', [
    ...
    public function testHasPluginData(): void
    {
        ...
        $DB->delete('zentra_plugin_formcreator_forms', [new QueryExpression('true')]);
    ...
    public function testFormMigrationConfigs(): void
    {
        ...
        $DB->insert('zentra_plugin_formcreator_entityconfigs', [
    ...
    public function testFormMigrationWithSpecificFormCategory(): void
    {
        ...
        $DB->insert('zentra_plugin_formcreator_categories', [
    ...
    public static function pluginHintsProvider(): iterable
    {
        yield [
            'type' => 'hidden',
            'expected_message' => 'The "hidden" question type is available in the "advancedforms" plugin: https://plugins.zentra-project.org/#/plugin/advancedforms',
        ];
        yield [
            'type' => 'ip',
            'expected_message' => 'The "ip" question type is available in the "advancedforms" plugin: https://plugins.zentra-project.org/#/plugin/advancedforms',
        ];
        yield [
            'type' => 'hostname',
            'expected_message' => 'The "hostname" question type is available in the "advancedforms" plugin: https://plugins.zentra-project.org/#/plugin/advancedforms',
        ];
        yield [
            'type' => 'ldapselect',
            'expected_message' => 'The "ldapselect" question type is available in the "advancedforms" plugin: https://plugins.zentra-project.org/#/plugin/advancedforms',
        ];
        yield [
            'type' => 'tag',
            'expected_message' => 'The "tag" question type is available in the "tag" plugin: https://plugins.zentra-project.org/#/plugin/tag',
        ];
        yield [
            'type' => 'fields',
            'expected_message' => 'The "fields" question type is available in the "fields" plugin: https://plugins.zentra-project.org/#/plugin/fields',
        ];
    }
    ...
    public function testFormWithQuestionReferencingGenericObject(): void
    {
        ...
        $this->assertEquals(
            "Zentra\CustomAsset\smartphoneAsset",
            $config->getItemtype()
        );
    }
    ...
    public static function provideITILObjectsRelationsMigration(): iterable
    {
        yield 'Item_Ticket relation' => [
            ...
            'relation_table' => 'zentra_items_tickets',
            'itil_fk'        => 'tickets_id',
        ];

        yield 'Change_Item relation' => [
            'itil_class'     => Change::class,
            'relation_table' => 'zentra_changes_items',
            'itil_fk'        => 'changes_id',
        ];

        yield 'Item_Problem relation' => [
            'itil_class'     => Problem::class,
            'relation_table' => 'zentra_items_problems',
            'itil_fk'        => 'problems_id',
        ];
    }
    ...
    public function testMigrationOfITILObjectsRelations(
        ...
        $DB->insert('zentra_plugin_formcreator_formanswers', [
            'plugin_formcreator_forms_id' => $form_id,
        ]);
