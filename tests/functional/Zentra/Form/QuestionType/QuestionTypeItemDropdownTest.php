    ...
    public static function dropdownRestrictionParamsProvider(): array
    {
        return [
            'simple dropdown with active items' => [
                ...
                ['WHERE' => ['zentra_requesttypes.is_active' => 1]],
            ],
            'ITILCategory with request filter' => [
                ...
                ['WHERE' => [
                    ['OR' => ['zentra_itilcategories.is_request' => 1]],
                ]],
            ],
            'ITILCategory with incident filter' => [
                ...
                ['WHERE' => [
                    ['OR' => ['zentra_itilcategories.is_incident' => 1]],
                ]],
            ],
            'ITILCategory with multiple filters' => [
                ...
                ['WHERE' => [
                    ['OR' => [
                        'zentra_itilcategories.is_request' => 1,
                        'zentra_itilcategories.is_incident' => 1,
                    ]],
                ]],
            ],
            'ITILCategory with change filter' => [
                ...
                ['WHERE' => [
                    ['OR' => ['zentra_itilcategories.is_change' => 1]],
                ]],
            ],
            'ITILCategory with problem filter' => [
                ...
                ['WHERE' => [
                    ['OR' => ['zentra_itilcategories.is_problem' => 1]],
                ]],
            ],
            'ITILCategory with all filters' => [
                ...
                'expected' => ['WHERE' => [
                    ['OR' => [
                        'zentra_itilcategories.is_request' => 1,
                        'zentra_itilcategories.is_incident' => 1,
                        'zentra_itilcategories.is_change' => 1,
                        'zentra_itilcategories.is_problem' => 1,
                    ]],
                ]],
            ],
        ];
