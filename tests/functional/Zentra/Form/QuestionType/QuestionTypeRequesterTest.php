...
use Zentra\Tests\Zentra\Form\QuestionType\AbstractQuestionTypeActorsTest;
use Group;
use User;
...
final class QuestionTypeRequesterTest extends AbstractQuestionTypeActorsTest
{
    ...
    {
        $zentra_id = getItemByTypeName(User::class, "zentra", true);
    ...
    public static function invalidActorsProvider(): iterable
    {
        ...
        yield 'valid user and invalid group' => [
            'answer' => [
                User::getForeignKeyField() . "-" . getItemByTypeName(User::class, "zentra", true),
    ...
    public static function validActorsProvider(): iterable
    {
        ...
        yield 'valid user' => [
            'answer' => [User::getForeignKeyField() . "-$zentra_id"],
            'expected' => [
                [
                    'itemtype' => User::class,
                    'items_id' => $zentra_id,
        ...
        yield 'multiple valid users' => [
            'answer' => [
                User::getForeignKeyField() . "-$zentra_id",
