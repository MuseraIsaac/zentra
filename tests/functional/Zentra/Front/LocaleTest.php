...
namespace tests\units\Zentra\Front;
...
class LocaleTest extends DbTestCase
{
    ...
    public function testFrontLocaleFile(string $locale, string $expected): void
    {
        ...
        $TRANSLATE->addTranslationFile('gettext', ZENTRA_I18N_DIR . '/en_GB.mo', 'zentra', 'en_GB');
        $TRANSLATE->addTranslationFile('gettext', ZENTRA_I18N_DIR . '/fr_FR.mo', 'zentra', 'fr_FR');

        // Act: render locale file
        $_GET['lang'] = $locale;
        $_GET['domain'] = 'zentra';
        ob_start();
        include(ZENTRA_ROOT . '/front/locale.php');
