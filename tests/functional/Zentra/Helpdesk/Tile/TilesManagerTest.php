...
namespace tests\units\Zentra\Form\Helpdesk\TilesManagerTest;

use CommonDBTM;
use Entity;
use Zentra\Application\View\TemplateRenderer;
use Zentra\Form\Form;
use Zentra\Helpdesk\Tile\ExternalPageTile;
use Zentra\Helpdesk\Tile\FormTile;
...
final class TilesManagerTest extends DbTestCase
{
    ...
    public function testTilesCanBeAddedToHelpdeskProfiles(): void
    {
        ...
        $manager->addTile($profile, ExternalPageTile::class, [
            'title'        => "ZENTRA project",
            'description'  => "Link to ZENTRA project website",
            'illustration' => "request-service",
            'url'          => "https://zentra-project.org",
        ]);
        $manager->addTile($profile, ZentraPageTile::class, [
            'title'        => "FAQ",
            'description'  => "Link to the FAQ",
            'illustration' => "browse-kb",
            'page'         => ZentraPageTile::PAGE_FAQ,
        ]);
        ...
        $this->assertEquals("ZENTRA project", $first_tile->getTitle());
        $this->assertEquals("Link to ZENTRA project website", $first_tile->getDescription());
        $this->assertEquals("request-service", $first_tile->getIllustration());
        $this->assertEquals("https://zentra-project.org", $first_tile->getTileUrl());

        $second_tile = $tiles[1];
        $this->assertInstanceOf(ZentraPageTile::class, $second_tile);
    ...
    public function testTilesAreOrderedByRanks(): void
    {
        ...
        $profile_tile_id = $manager->addTile($profile, ZentraPageTile::class, [
            'title'        => "FAQ",
            'description'  => "Link to the FAQ",
            'illustration' => "browse-kb",
            'page'         => ZentraPageTile::PAGE_FAQ,
        ...
        $third_tile = $tiles[2];
        $this->assertInstanceOf(ZentraPageTile::class, $third_tile);
    ...
    public function testTilesOrderCanBeSet(): void
    {
        ...
        $profile_tile_id_2 = $manager->addTile($profile, ZentraPageTile::class, [
            'title'        => "FAQ",
            'description'  => "Link to the FAQ",
            'illustration' => "browse-kb",
            'page'         => ZentraPageTile::PAGE_FAQ,
        ...
        $second_tile = $tiles[1];
        $this->assertInstanceOf(ExternalPageTile::class, $second_tile);
        $this->assertEquals("ZENTRA project", $second_tile->getTitle());
        $this->assertEquals("Link to ZENTRA project website", $second_tile->getDescription());
        $this->assertEquals("request-service", $second_tile->getIllustration());
        $this->assertEquals("https://zentra-project.org", $second_tile->getTileUrl());
    ...
    public function testDeleteTile(): void
    {
        ...
        $this->getManager()->deleteTile(ZentraPageTile::getById($tile_id));
        ...
        $this->assertFalse(ZentraPageTile::getById($tile_id));
    }
    ...
    public function testZentraPageTileCascadeDeletion(): void
    {
        // Arrange: create a zentra page tile
        $manager = $this->getManager();
        $item_tile_id = $manager->addTile(
            $this->getTestRootEntity(),
    ...
    public function testTilesTypesAreSortedByWeight(): void
    {
        ...
        $this->assertInstanceOf(ZentraPageTile::class, $types[1]);
    ...
    public function testServiceCatalogTileIsVisibleIfServiceCatalogIsEnabled(): void
    {
        ...
        $manager->addTile($profile, ZentraPageTile::class, [
            ...
            'illustration' => "request-service",
            'page'         => ZentraPageTile::PAGE_SERVICE_CATALOG,
        ]);
        $this->login();
