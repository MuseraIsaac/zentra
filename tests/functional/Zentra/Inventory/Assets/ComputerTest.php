...
namespace tests\units\Zentra\Inventory\Asset;
...
use Zentra\Tests\AbstractInventoryAsset;
...
<REQUEST>
  ...
  <QUERY>INVENTORY</QUERY>
                ...
                'asset' => '{"chassis_type":"Laptop","datelastloggeduser":"Wed Oct 3 06:56","defaultgateway":"192.168.1.1","dns":"192.168.1.1\\/172.28.200.20","lastloggeduser":"trasher","memory":7822,"name":"zentraxps","swap":7951,"uuid":"4c4c4544-0034-3010-8048-b6c04f503732","vmsystem":"Physical","workgroup":"teclib.infra","domains_id":"teclib.infra","users_id":0,"contact":"trasher","manufacturers_id":"Dell Inc.","computermodels_id":"XPS 13 9350","serial":"640HP72","mserial":"\\/640HP72\\/CN129636460078\\/","computertypes_id":"Laptop","autoupdatesystems_id":"ZENTRA Native Inventory","last_inventory_update": "DATE_NOW","is_deleted": 0}',
            ], [ //only hardware
                'xml' => "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>
<REQUEST>
  <CONTENT>
  ...
  <QUERY>INVENTORY</QUERY>
                ...
                'asset' => '{"chassis_type":"Laptop","datelastloggeduser":"Wed Oct 3 06:56","defaultgateway":"192.168.1.1","dns":"192.168.1.1\\/172.28.200.20","lastloggeduser":"trasher","memory":7822,"name":"zentraxps","swap":7951,"uuid":"4c4c4544-0034-3010-8048-b6c04f503732","vmsystem":"Physical","workgroup":"teclib.infra","domains_id":"teclib.infra","users_id":0,"contact":"trasher","computertypes_id":"Laptop","autoupdatesystems_id":"ZENTRA Native Inventory","last_inventory_update": "DATE_NOW","is_deleted": 0}',
            ], [ //only bios
                'xml' => "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>
<REQUEST>
  <CONTENT>
  ...
  <QUERY>INVENTORY</QUERY>
                ...
                'asset' => '{"manufacturers_id":"Dell Inc.","computermodels_id":"XPS 13 9350","serial":"640HP72","mserial":"\\/640HP72\\/CN129636460078\\/","autoupdatesystems_id":"ZENTRA Native Inventory","last_inventory_update": "DATE_NOW","is_deleted": 0}',
...
<REQUEST>
  ...
  <QUERY>INVENTORY</QUERY>
                ...
                'asset' => '{"manufacturers_id":"Dell Inc.","computermodels_id":"XPS 13 9350","serial":"640HP72","mserial":"\\/640HP72\\/CN129636460078\\/","otherserial":"SER1234","autoupdatesystems_id":"ZENTRA Native Inventory","last_inventory_update": "DATE_NOW","is_deleted": 0}',
            ],
        ];
    }
    ...
    public function testPrepare($xml, $asset)
    {
        ...
        $_SESSION['zentra_currenttime'] = $date_now;
        ...
        $main = new \Zentra\Inventory\MainAsset\Computer($computer, $json);
...
<REQUEST>
  ...
  <QUERY>INVENTORY</QUERY>
        ...
        $this->assertSame('zentraxps.teclib.infra-2018-10-03-08-42-36', $agent['deviceid']);
...
<REQUEST>
  <CONTENT>
    <HARDWARE>
      <NAME>zentraxps</NAME>
      <UUID>25C1BB60-5BCB-11D9-B18F-5404A6A534C4</UUID>
      <LASTLOGGEDUSER>zentra</LASTLOGGEDUSER>
    </HARDWARE>
    <BIOS>
      <ASSETTAG>SER1234</ASSETTAG>
      <BDATE>06/02/2016</BDATE>
...
<REQUEST>
  ...
  <QUERY>INVENTORY</QUERY>
    ...
    public function testInventoryDefaultEntity()
    {
        ...
        <DEVICEID>zentraxpsxps.teclib.infra-2018-10-03-08-42-36</DEVICEID>
        <QUERY>INVENTORY</QUERY>
        </REQUEST>";
...
<REQUEST>
  ...
  <QUERY>INVENTORY</QUERY>
    ...
    public function testReimportWithLockedStatesId()
    {
        ...
        $json_str = file_get_contents(ZENTRA_ROOT . '/tests/fixtures/inventories/computer_locked_states_id.json');
        $json = json_decode($json_str);
        ...
        $json_source = <<<JSON
{
   ...
   "content": {
      ...
      "versionclient": "ZENTRA-Inventory_v1.15"
   },
    ...
    public function testControllersCaptions(): void
    {
        $json_source = '{
            ...
            "content": {
                ...
                "versionclient": "ZENTRA-Agent_v1.9"
            },
            "deviceid": "ARN2032",
            "itemtype": "Computer"
        }';
