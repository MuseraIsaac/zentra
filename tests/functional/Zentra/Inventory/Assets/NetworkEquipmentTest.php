  ...
  <CONTENT>
    <DEVICE>
      ...
      <INFO>
        ...
        <CONTACT>noc@zentra-project.org</CONTACT>
        <CPU>4</CPU>
...
Compiled Mon 23-Jul-12 13:22 by prod_rel_team</COMMENTS>
  ...
  <QUERY>SNMPQUERY</QUERY>
    ...
    public function testPrepare($xml, $asset)
    {
        ...
        $main = new \Zentra\Inventory\MainAsset\NetworkEquipment($netequ, $json);
...
<REQUEST>
  ...
  <QUERY>SNMPQUERY</QUERY>
        ...
        // Import the switch(es) into ZENTRA
        $converter = new Converter();
...
<REQUEST>
  ...
  <QUERY>SNMPQUERY</QUERY>
        ...
        $links = getAllDataFromTable('zentra_networkports_networkports');
        ...
        $a_networkports = getAllDataFromTable('zentra_networkports');
...
<REQUEST>
  ...
  <QUERY>SNMPQUERY</QUERY>
        ...
        $a_portslinks = getAllDataFromTable('zentra_networkports_networkports');
...
<REQUEST>
  ...
  <QUERY>SNMPQUERY</QUERY>
        ...
        //FIXME: does not work :'(
        //$a_unknowns = getAllDataFromTable('zentra_unmanageds');
...
<REQUEST>
  ...
  <QUERY>SNMPQUERY</QUERY>
    ...
    public function testPrepareConnections($json_source)
    {
        ...
        $asset = new \Zentra\Inventory\Asset\NetworkPort($networkEquipment, (array) $json->content->network_ports);
        $asset->setMainAsset(new \Zentra\Inventory\MainAsset\NetworkEquipment($networkEquipment, []));
...
<REQUEST>
  ...
  <QUERY>NETDISCOVERY</QUERY>
        ...
        $main = new \Zentra\Inventory\MainAsset\NetworkEquipment($network_equipement, $json);
        $main->setAgent($agent)->setExtraData($data);
        $main->checkConf(new Conf());
...
<REQUEST>
  ...
  <QUERY>NETDISCOVERY</QUERY>
    ...
    public function testNeedToBeUpdatedFromDiscovery()
    {
        ...
        $result = \Zentra\Inventory\MainAsset\NetworkEquipment::needToBeUpdatedFromDiscovery($networkEquipment, $val);
        ...
        $result = \Zentra\Inventory\MainAsset\NetworkEquipment::needToBeUpdatedFromDiscovery($networkEquipment2, $val);
