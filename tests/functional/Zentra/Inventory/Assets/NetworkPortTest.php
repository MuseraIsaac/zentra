...
Compiled Mon 23-Jul-12 13:22 by prod_rel_team</COMMENTS>
        ...
        <NAME>3k-1-pa.zentra-project.org</NAME>
        <RAM>128</RAM>
      ...
      <PORTS>
        <PORT>
          ...
          <IFALIAS>lag1.zentra-project.org</IFALIAS>
        ...
        <PORT>
          <IFALIAS>net1.zentra-project.org</IFALIAS>
        ...
        <PORT>
          <IFALIAS>net2.zentra-project.org</IFALIAS>
          ...
          <VLANS>
            <VLAN>
              ...
              <NUMBER>206</NUMBER>
                ...
                'ports'  => [
                    '{"ifalias":"lag1.zentra-project.org","ifdescr":"Port-channel6","ifinerrors":0,"ifinternalstatus":1,"iflastchange":"32.65 seconds","ifmtu":9000,"ifname":"Po6","ifnumber":5006,"ifouterrors":0,"ifspeed":2000000000,"ifstatus":1,"iftype":56,"mac":"00:14:a9:37:ee:2d","trunk":false,"instantiation_type":"NetworkPortFiberchannel","name":"Po6","logical_number":5006,"ifinbytes":82823274,"ifoutbytes":657139488}',
                    '{"ifalias":"net1.zentra-project.org","ifdescr":"GigabitEthernet4\/0\/46","ifinerrors":0,"ifinternalstatus":1,"iflastchange":"5 minutes, 50.26","ifmtu":9000,"ifname":"Gi4\/0\/46","ifnumber":11646,"ifouterrors":0,"ifportduplex":3,"ifspeed":1000000000,"ifstatus":1,"iftype":6,"mac":"00:19:2f:08:8f:2e","trunk":false,"instantiation_type":"NetworkPortEthernet","name":"Gi4\/0\/46","logical_number":11646,"portduplex":3,"ifinbytes":38145664,"ifoutbytes":167335360}',
                    '{"ifalias":"net2.zentra-project.org","ifdescr":"GigabitEthernet8\/0\/45","ifinerrors":0,"ifinternalstatus":1,"iflastchange":"30.69 seconds","ifmtu":9000,"ifname":"Gi8\/0\/45","ifnumber":13645,"ifouterrors":0,"ifportduplex":3,"ifspeed":1000000000,"ifstatus":1,"iftype":6,"mac":"00:14:a9:37:ee:2d","trunk":false,"instantiation_type":"NetworkPortEthernet","name":"Gi8\/0\/45","logical_number":13645,"portduplex":3,"ifinbytes":40326934,"ifoutbytes":454911808}',
                ],
    ...
    public function testPrepare($xml, $ports, $connections, $vlans, $aggregates)
    {
        ...
        $asset = new \Zentra\Inventory\Asset\NetworkPort($neteq, $json->content->network_ports);
        $asset->setMainAsset(new \Zentra\Inventory\MainAsset\NetworkEquipment($neteq, []));
    ...
    public function testInstantiationType()
    {
        ...
        $json_str = '
        {
            ...
            "content": {
                ...
                "versionclient": "ZENTRA-Agent_v1.4-1"
            },
    ...
    public function testNetworkEquipmentsConnections(): void
    {
        ...
        // Import the linked network equipment into ZENTRA
