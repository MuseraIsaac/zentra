...
class OperatingSystemTest extends AbstractInventoryAsset
{
    ...
    public function testPrepare($nodes, $expected)
    {
        ...
        $asset = new \Zentra\Inventory\Asset\OperatingSystem($computer, (array) $json->content->operatingsystem);
