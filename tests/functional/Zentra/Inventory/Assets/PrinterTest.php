...
<REQUEST>
  ...
  <QUERY>INVENTORY</QUERY>
    ...
    public function testPrepare($xml, $expected)
    {
        ...
        $expected = str_replace('DATE_NOW', $_SESSION['zentra_currenttime'], $expected);
        ...
        $asset = new \Zentra\Inventory\Asset\Printer($computer, $json->content->printers);
        $conf = new Conf();
    ...
    public function testSnmpPrinter()
    {
        ...
        $main = new \Zentra\Inventory\MainAsset\Printer($printer, $json);
...
<REQUEST>
  ...
  <QUERY>INVENTORY</QUERY>
    ...
    public function testSnmpPrinterDiscoveryUpdateAllowed()
    {
        ...
        $this->assertSame([], $main->getNetworkPorts());
        //Since this -> https://github.com/zentra-project/zentra/pull/12197
