...
<REQUEST>
  ...
  <QUERY>INVENTORY</QUERY>
    ...
    public function testPrepare($xml, $expected)
    {
        ...
        $asset = new \Zentra\Inventory\Asset\Software($computer, $json->content->softwares);
    ...
    public function testHandle()
    {
        ...
        $computer = getItemByTypeName('Computer', '_test_pc01');
        $asset = new \Zentra\Inventory\Asset\Software($computer, $json->content->softwares);
        $osasset = new \Zentra\Inventory\Asset\OperatingSystem($computer, (array) $json->content->operatingsystem);
        $osasset->prepare();
        //handle
        $osasset->handleLinks();
        $osasset->handle();
        ...
        $extra_data = (array) $json->content;
        $extra_data[\Zentra\Inventory\Asset\OperatingSystem::class] = $osasset;
        ...
        $asset = new \Zentra\Inventory\Asset\Software($computer2, $json->content->softwares);
        $osasset = new \Zentra\Inventory\Asset\OperatingSystem($computer2, (array) $json->content->operatingsystem);
        $osasset->prepare();
        //handle
        $osasset->handleLinks();
        $osasset->handle();
