...
",
    ...
    public function testInventory()
    {
        ...
        $this->assertEquals($_SESSION['zentra_currenttime'], $unmanaged->fields['last_inventory_update']);
        ...
        //check last_inventory_update
        $this->assertEquals($_SESSION['zentra_currenttime'], $computer->fields['last_inventory_update']);
        ...
        //check users_id is always zentra
        $this->assertEquals(getItemByTypeName('User', 'zentra', true), $computer->fields['users_id']);
    ...
    public function testAgentNotDeleted()
    {
        ...
        <CONTENT>
            <DEVICE>
            <DNSHOSTNAME>zentraxps</DNSHOSTNAME>
            <ENTITY>0</ENTITY>
            <IP>192.168.1.20</IP>
        ...
        $unmanaged = new \Unmanaged();
        $this->assertFalse($unmanaged->getFromDbByCrit(['name' => 'zentraxps']));
        ...
        $json_str = '
        {
            ...
            "content": {
                ...
                "versionprovider": {
                    ...
                    "perl_inc": "\/usr\/share\/zentra-agent\/lib:\/etc\/perl:\/usr\/local\/lib\/x86_64-linux-gnu\/perl\/5.34.0:\/usr\/local\/share\/perl\/5.34.0:\/usr\/lib\/x86_64-linux-gnu\/perl5\/5.34:\/usr\/share\/perl5:\/usr\/lib\/x86_64-linux-gnu\/perl-base:\/usr\/lib\/x86_64-linux-gnu\/perl\/5.34:\/usr\/share\/perl\/5.34:\/usr\/local\/lib\/site_perl",
                    "perl_module": [
                        "LWP @ 6.61",
                        "LWP::Protocol @ 6.61",
                        "IO::Socket @ 1.46",
