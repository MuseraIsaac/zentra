...
namespace tests\units\Zentra\Inventory;
...
class InventoryTest extends InventoryTestCase
{
    private function checkComputer1($computers_id)
    {
        ...
        $autoupdatesystems = $DB->request(['FROM' => \AutoupdateSystem::getTable(), 'WHERE' => ['name' => 'ZENTRA Native Inventory']])->current();
    ...
    public function testImportNetworkEquipment()
    {
        ...
        $expected = [
            ...
            'serial' => 'SSI1912014B',
            'otherserial' => null,
            'contact' => 'noc@zentra-project.org',
            'contact_num' => null,
            'users_id_tech' => 0,
...
Compiled Tue 28-Sep-10 13:44 by prod_rel_team",
    ...
    public function testImportStackedNetworkEquipment()
    {
        ...
        $this->assertCount(5, $metadata);
        $this->assertSame('3k-1-pa3.zentra-project.infra-2020-12-31-11-28-51', $metadata['deviceid']);
        $this->assertSame('4.1', $metadata['version']);
        $this->assertSame('NetworkEquipment', $metadata['itemtype']);
        $this->assertNull($metadata['port']);
        $this->assertSame('netinventory', $metadata['action']);
        ...
        $this->assertSame('3k-1-pa3.zentra-project.infra-2020-12-31-11-28-51', $inventory->getAgent()->fields['deviceid']);
        $this->assertSame('3k-1-pa3.zentra-project.infra-2020-12-31-11-28-51', $inventory->getAgent()->fields['name']);
        ...
        $main_expected = [
            ...
            'entities_id' => 0,
            'is_recursive' => 0,
            'name' => '3k-1-pa3.zentra-project.infra',
            'ram' => 128,
            'serial' => 'FOC1243W0ED',
            'otherserial' => null,
            'contact' => null,
    ...
    public function testImportRefusedFromAssetRulesWithLog()
    {
        ...
        $this->assertSame('zentraxps', $computer->fields['name']);
    ...
    public function testUpdateVirtualMachines()
    {
        ...
        $this->assertSame('zentra-10-rc1', $cvms->fields['name']);
    ...
    public function testImportDatabases()
    {
        ...
        $db_zentra = &$dbs[0];
        $db_zentra->size = 55000;
        $db_zentra->last_backup_date = '2021-06-25 08:52:44';
        ...
        $database = array_pop($databases);
        $this->assertIsArray($database);
        $this->assertSame('zentra', $database['name']);
    ...
    public function testAssignUserByFieldAndRegex($rules_fields, $xml_fields, $result)
    {
        ...
        switch ($result['users_id']) {
            ...
            case 'NORMAL_ID':
                ...
                break;
            case 'ZENTRA_ID':
                $zentra_id = \User::getIDByName('zentra');
                $this->createItem(UserEmail::class, [
                    'users_id' => $zentra_id,
                    'is_default' => 1,
                    'email' => 'zentra@teclib.com',
                ]);
                $result['users_id'] = $zentra_id;
                break;
            case 'TEST_ID':
        ...
        <CONTENT>
          ...
          <VERSIONCLIENT>ZENTRA-Agent_v1.6.18</VERSIONCLIENT>
        </CONTENT>
...
<REQUEST>
  <CONTENT>
    <HARDWARE>
      <NAME>zentraxps-rule-auto-test</NAME>
  ...
  <QUERY>INVENTORY</QUERY>
    ...
    public function testLocationHierarchy()
    {
        ...
        $locations = $DB->request(['FROM' => 'zentra_locations']);
...
<REQUEST>
  ...
  <QUERY>SNMPQUERY</QUERY>
        ...
        $locations = $DB->request(['FROM' => 'zentra_locations', 'ORDER' => 'id DESC']);
        ...
        $json_str = <<<JSON
{
    ...
    "content": {
        ...
        "versionclient": "ZENTRA-Agent_v1.10-dev"
    },
        ...
        $json_str = <<<JSON
{
   ...
   "content": {
      ...
      "versionclient": "ZENTRA-Inventory_v1.11"
   },
        ...
        = <<<JSON
            {
                ...
                "content": {
                    ...
                    "versionclient": "ZENTRA-Test_v1.10-dev"
                },
...
JSON;
    ...
    public function testRuleActionLinkOrNoImport()
    {
        ...
        <CONTENT>
          ...
          <VERSIONCLIENT>ZENTRAAgent-Inventory_v2.4.1-2.fc28</VERSIONCLIENT>
        </CONTENT>
        <DEVICEID>zentraxps.teclib.infra</DEVICEID>
        <QUERY>INVENTORY</QUERY>
        </REQUEST>";
