...
class SetDbSessionVarsTest extends ZENTRATestCase
{
    ...
    public function testOnPostBootSetDbSessionVars(
        ...
        if ($session_timezone !== null) {
            $_SESSION['zentratimezone'] = $session_timezone;
        } else {
            unset($_SESSION['zentratimezone']);
        }
    ...
    public function testOnPostBootWithDisconnectedDatabase(): void
    {
        ...
        try {
            ...
            $_SESSION['zentratimezone'] = 'Europe/Paris';
