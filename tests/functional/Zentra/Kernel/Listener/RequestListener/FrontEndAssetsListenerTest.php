...
class FrontEndAssetsListenerTest extends ZENTRATestCase
{
    ...
    public static function pathProvider(): iterable
    {
        ...
        $zentra_exposed_static_files = [
            '/js/common.js',
        ];
        $zentra_protected_static_files = [
        ...
        foreach ($zentra_exposed_static_files as $file) {
            // exposed ZENTRA static files should be served
            yield $file => [
                'url_path'  => $file,
                'file_path' => $file,
                'is_served' => true,
        ...
        foreach ($zentra_protected_static_files as $file) {
            // protected ZENTRA static files should NOT be served
            yield $file => [
                'url_path'  => $file,
                'file_path' => $file,
                'is_served' => false,
        ...
        $not_served_files = \array_merge(
            $zentra_php_files, // ZENTRA PHP files should NOT be served by this listener
