...
use ZentraPlugin\Tester\MyPsr4Dropdown;
...
final class LegacyItemtypeRouteListenerTest extends TestCase
{
    ...
    public function testFindZentraClass(string $path_info, string $expected_class_name): void
    {
    ...
    public static function provideClassesForPlugin(): iterable
    {
        ...
        yield [
            ...
            'class'     => \ZentraPlugin\Tester\Computer::class,
        ];
    }
