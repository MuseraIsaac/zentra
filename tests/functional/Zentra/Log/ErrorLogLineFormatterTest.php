...
use Zentra\Log\ErrorLogLineFormatter;
use Monolog\Level;
...
class ErrorLogLineFormatterTest extends TestCase
{
    public static function logRecordProvider(): iterable
    {
        yield [
            'record' => new LogRecord(
                ...
                channel: 'zentrasyslog',
                level: Level::Emergency,
                message: 'Fatal Error ...',
            ),
            'expected' => '[2022-08-14 11:45:32] zentrasyslog.EMERGENCY:   *** Fatal Error ...',
        ];
        yield [
            'record' => new LogRecord(
                datetime: new DateTimeImmutable('2024-04-12 21:45:32'),
                channel: 'zentraphplog',
                level: Level::Alert,
                message: 'An unexpected error occurred',
            ),
            'expected' => '[2024-04-12 21:45:32] zentraphplog.ALERT:   *** An unexpected error occurred',
        ];
        yield [
            'record' => new LogRecord(
            ...
            'expected' => '[2024-08-12 21:45:32] zentraphplog.CRITICAL:   *** Uncaught Exception ...',
        ];
        yield [
            'record' => new LogRecord(
                datetime: new DateTimeImmutable('2024-08-12 21:45:32'),
            ...
            'expected' => '[2024-08-12 21:45:32] zentraphplog.ERROR:   *** Unable to do something',
        ];
        yield [
            'record' => new LogRecord(
                datetime: new DateTimeImmutable('2024-08-12 21:45:32'),
            ...
            'expected' => '[2024-08-12 21:45:32] zentraphplog.WARNING:   *** Failed to format the value XXX',
        ];
        yield [
            'record' => new LogRecord(
            ...
            'expected' => '[2019-03-17 09:12:46] zentraphplog.NOTICE:   *** Value seems weird, but is valid',
        ];
        yield [
            'record' => new LogRecord(
                datetime: new DateTimeImmutable('2019-03-17 09:12:46'),
            ...
            'expected' => '[2019-03-17 09:12:46] zentraphplog.INFO:   *** Connection established to the remote server',
        ];
        yield [
            'record' => new LogRecord(
                datetime: new DateTimeImmutable('2019-03-17 09:12:46'),
            ...
            'expected' => '[2019-03-17 09:12:46] zentraphplog.DEBUG:   *** debug trace',
        ];
    }
    ...
    public function testFormatExceptionTrace(): void
    {
        ...
        $this->assertSame(
            '[2024-08-12 21:45:32] zentraphplog.CRITICAL:   *** Uncaught PHP Exception RuntimeException: "Operation failed!"',
            $lines[0]
        );
        $this->assertSame(
            '  Backtrace :',
        ...
        $this->assertSame(
            '  ...onal/Zentra/Log/ErrorLogLineFormatterTest.php:145 ',
            $lines[2]
        );
        $this->assertMatchesRegularExpression(
            '#.*phpunit/src/Framework/TestCase\.php:\d+ tests\\\units\\\Zentra\\\Log\\\ErrorLogLineFormatterTest->testFormatExceptionTrace\(\)#',
            $lines[3]
        );
