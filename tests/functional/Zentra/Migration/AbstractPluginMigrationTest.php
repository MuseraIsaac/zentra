...
class AbstractPluginMigrationTest extends DbTestCase
{
    public function testExecuteWithUnvalidatedPrerequisites(): void
    {
        ...
        $instance = new class ($db) extends AbstractPluginMigration {
            ...
            {
                $this->result->addMessage(MessageType::Error, 'Appliances plugin table "zentra_plugins_myplugin_items" is missing.');
                return false;
            }
        ...
        $expected_messages = [
            [
                ...
                'message' => 'Appliances plugin table "zentra_plugins_myplugin_items" is missing.',
            ],
            [
                'type' => MessageType::Error,
    ...
    public function testCheckDbFieldsExists(): void
    {
        ...
        $db->method('tableExists')->willReturnCallback(function ($table) {
            return match ($table) {
                'zentra_plugins_myplugin_items' => true,
                'zentra_plugins_myplugin_tickets' => true,
                'zentra_plugins_myplugin_bars' => true,
                default => false,
            };
        });
        $db->method('fieldExists')->willReturnCallback(function ($table, $field) {
            return match ($table . '.' . $field) {
                'zentra_plugins_myplugin_items.id' => true,
                'zentra_plugins_myplugin_items.name' => true,
                'zentra_plugins_myplugin_tickets.id' => true,
                'zentra_plugins_myplugin_tickets.name' => true,
                'zentra_plugins_myplugin_tickets.content' => true,
                'zentra_plugins_myplugin_bars.id' => true,
                default => false,
            };
        });
        ...
        $return_1 = $this->callPrivateMethod(
            ...
            'checkDbFieldsExists',
            [
                'zentra_plugins_myplugin_items' => ['id', 'name', 'items_id', 'plugin_myplugin_categories_id'],
                'zentra_plugins_myplugin_tickets' => ['id', 'name', 'content'],
                'zentra_plugins_myplugin_categories' => ['id', 'name'],
                'zentra_plugins_myplugin_foos' => ['id', 'name'],
                'zentra_plugins_myplugin_bars' => ['id', 'name'],
            ]
        );
        ...
        $return_2 = $this->callPrivateMethod(
            ...
            'checkDbFieldsExists',
            [
                'zentra_plugins_myplugin_items' => ['id', 'name'],
                'zentra_plugins_myplugin_tickets' => ['id', 'name', 'content'],
            ]
        );
        ...
        $expected_messages = [
            ...
            [
                'type' => MessageType::Error,
                'message' => 'The following database tables are missing: `zentra_plugins_myplugin_categories`, `zentra_plugins_myplugin_foos`.',
            ],
            [
                'type' => MessageType::Error,
                'message' => 'The following database fields are missing: `zentra_plugins_myplugin_items.items_id`, `zentra_plugins_myplugin_items.plugin_myplugin_categories_id`, `zentra_plugins_myplugin_bars.name`.',
            ],
        ];
    ...
    public function testImportItem(): void
    {
        ...
        $expected_messages = [
            ...
            [
                'type' => MessageType::Debug,
                'message' => sprintf('Computer "_test_pc03" (%d) is most recent on ZENTRA side, its update has been skipped.', $computer_id_3),
            ],
            [
                'type' => MessageType::Debug,
