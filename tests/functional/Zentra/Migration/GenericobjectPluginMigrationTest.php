...
namespace tests\units\Zentra\Migration;
...
class GenericobjectPluginMigrationTest extends DbTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $queries = $DB->getQueriesFromFile(sprintf('%s/tests/fixtures/genericobject-migration/zentra-data.sql', ZENTRA_ROOT));
        foreach ($queries as $query) {
            $DB->doQuery($query);
        }
    }
    ...
    public function testProcessMigration(): void
    {
        ...
        $plugin_itemtypes = \array_column(
            \getAllDataFromTable('zentra_plugin_genericobject_types'),
            'itemtype'
        );
        ...
        $this->checkItems(
            ...
            [
                [
                    ...
                    'custom_dropdowns_dropdowns_id_smartphonecategory' => \getItemByTypeName('Zentra\\CustomDropdown\\SmartphoneCategoryDropdown', 'Cat 5', true),
                    'custom_assets_assets_id_tablet' => \getItemByTypeName('Zentra\\CustomAsset\\TabletAsset', 'Tablet 1', true),
                    'custom_dropdowns_dropdowns_id_bar' => \getItemByTypeName('Zentra\\CustomDropdown\\BarDropdown', 'Bar 3', true),
                    'custom_dropdowns_dropdowns_id_foo' => \getItemByTypeName('Zentra\\CustomDropdown\\FooDropdown', 'Foo 2', true),
                    'custom_dropdowns_dropdowns_id_item_state' => 0,
                    'custom_dropdowns_dropdowns_id_test_abc' => \getItemByTypeName('Zentra\\CustomDropdown\\Test_AbcDropdown', 'Test 1', true),
                ...
                [
                    ...
                    'custom_other' => '',
                    'custom_url' => '',
                    'custom_dropdowns_dropdowns_id_smartphonecategory' => \getItemByTypeName('Zentra\\CustomDropdown\\SmartphoneCategoryDropdown', 'Cat 4', true),
                    'custom_assets_assets_id_tablet' => 0,
                    'custom_dropdowns_dropdowns_id_bar' => \getItemByTypeName('Zentra\\CustomDropdown\\BarDropdown', 'Bar 4', true),
                    'custom_dropdowns_dropdowns_id_foo' => 0,
                    'custom_dropdowns_dropdowns_id_item_state' => \getItemByTypeName('Zentra\\CustomDropdown\\Item_StateDropdown', 'State 3', true),
                ...
                [
                    ...
                    'custom_assets_assets_id_tablet' => \getItemByTypeName('Zentra\\CustomAsset\\TabletAsset', 'Tablet 3', true),
                    'custom_dropdowns_dropdowns_id_bar' => 0,
                    'custom_dropdowns_dropdowns_id_foo' => 0,
                    'custom_dropdowns_dropdowns_id_item_state' => \getItemByTypeName('Zentra\\CustomDropdown\\Item_StateDropdown', 'State 1', true),
                    'custom_dropdowns_dropdowns_id_test_abc' => \getItemByTypeName('Zentra\\CustomDropdown\\Test_AbcDropdown', 'Test 2', true),
