...
namespace tests\units\Zentra\OAuth;

use DateTimeImmutable;
use Zentra\OAuth\AccessToken;
use Zentra\OAuth\RefreshToken;
use Zentra\OAuth\RefreshTokenRepository;
...
class RefreshTokenRepositoryTest extends DbTestCase
{
    public function testPersistNewRefreshToken(): void
    {
        ...
        $this->assertTrue($DB->insert('zentra_oauth_refresh_tokens', [
        ...
        $it = $DB->request([
            'FROM' => 'zentra_oauth_refresh_tokens',
