...
namespace tests\units\Zentra\Progress;

use Zentra\Message\MessageType;
use Zentra\Progress\ProgressStorage;
use Zentra\Progress\StoredProgressIndicator;
use Zentra\Tests\ZENTRATestCase;
use org\bovigo\vfs\vfsStream;

class ProgressStorageTest extends ZENTRATestCase
{
    public function testSpawnProgressIndicator(): void
    {
        ...
        $storage = new ProgressStorage(vfsStream::url('zentra/files/_tmp'));
        ...
        $expected_file_path = vfsStream::url('zentra/files/_tmp/' . $progress_indicator->getStorageKey() . '.progress');
