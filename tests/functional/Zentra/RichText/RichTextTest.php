...
namespace tests\units\Zentra\RichText;
...
class RichTextTest extends ZENTRATestCase
{
...
<root>
  ...
  <url>http://www.zentra-project.org/void?test=1&amp;debug=1</url>
</root>
XML;
...
2. contained URL are no longer transformed into links:
 - www.zentra-project.org
 - mailto:test@zentra-project.org
...
2. contained URL are no longer transformed into links:<br />
 - www.zentra-project.org<br />
 - mailto:test&#64;zentra-project.org<br />
</p>
HTML,
        ];
...
<p>
  ...
  <a href="mailto:test@zentra-project.org">mailto link</a>,
  ...
</p>
<ul>
  <li>
...
HTML,
        ...
        yield 'User mention tag must be preserved' => [
            'content' => <<<HTML
<p>
  Hi <span contenteditable="false" data-user-mention="true" data-user-id="2">@zentra</span>&nbsp;
  ...
</p>
HTML,
            'encode_output_entities' => false,
...
HTML,
    ...
    public function testGetSafeHtmlDoChangeDocPath()
    {
        ...
        foreach (['', '/zentra', '/path/to/zentra'] as $expected_prefix) {
            $CFG_ZENTRA['root_doc'] = $expected_prefix;
            foreach (['/previous/zentra/path', '', '/zentra'] as $previous_prefix) {
                $content = <<<HTML
    <p>
      Images path should be corrected when root doc changed:
...
XML;
        $content = '<h1>XML example</h1>' . "\n" . htmlspecialchars($xml_sample);
        $result  = <<<PLAINTEXT
XML example <?xml version="1.0" encoding="UTF-8"?> <root> <desc><![CDATA[Some CDATA content]]></desc> <url>http://www.zentra-project.org/void?test=1&amp;debug=1</url> </root>
PLAINTEXT;
        yield [
            'content'                => $content,
            'keep_presentation'      => false,
...
Text in a paragraph
 ...
 [an image] [{$CFG_ZENTRA['url_base']}/front/computer.form.php?id=150] Should I yell FOR THE IMPORTANT WORDS? 
PLAINTEXT,
        ];
