...
use Zentra\System\Diagnostic\DatabaseSchemaConsistencyChecker;
use Zentra\Tests\ZENTRATestCase;
use PHPUnit\Framework\Attributes\DataProvider;

class DatabaseSchemaConsistencyCheckerTest extends ZENTRATestCase
{
...
SQL,
    ...
    public function testGetMissingFields(
        ...
        $table_name = sprintf('zentratests_%s', uniqid());
