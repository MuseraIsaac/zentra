...
namespace tests\units\Zentra\System\Log;

use Zentra\System\Log\LogParser;
use Zentra\Tests\ZENTRATestCase;

class LogParserTest extends ZENTRATestCase
{
    private string $log_file_path = ZENTRA_LOG_DIR . '/test.log';
