...
class PhpSupportedVersionTest extends ZENTRATestCase
{
    public static function versionProvider(): iterable
    {
        yield [
            ...
            'messages'   => [
                ...
                'Even if ZENTRA still supports this PHP version, an upgrade to a more recent PHP version is recommended.',
