...
class SessionsSecurityConfigurationTest extends ZENTRATestCase
{
    ...
    public function testCheckWithLowercaseLaxSameSiteConfig(
        ...
        $this->assertEquals(
            [
                ...
                'PHP directive "session.cookie_secure" should be set to "on" when ZENTRA can be accessed on HTTPS protocol.',
