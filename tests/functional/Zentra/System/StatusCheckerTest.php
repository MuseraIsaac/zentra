...
namespace tests\units\Zentra\System;
...
class StatusCheckerTest extends ZENTRATestCase
{
    ...
    public function testDefaultStatus()
    {
        ...
        $known_services = ['db', 'cas', 'ldap', 'imap', 'mail_collectors', 'crontasks', 'filesystem', 'zentra', 'plugins'];
        ...
        $this->assertEquals(StatusChecker::STATUS_OK, $status['zentra']['status']);
    ...
    public function testBadStatus()
    {
        ...
        $status = StatusChecker::getServiceStatus(service: null);
        $this->assertEquals(StatusChecker::STATUS_PROBLEM, $status['zentra']['status']);
    }
