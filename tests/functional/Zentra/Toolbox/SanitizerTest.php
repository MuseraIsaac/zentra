...
use Zentra\Toolbox\Sanitizer;
use PHPUnit\Framework\Attributes\DataProvider;

class SanitizerTest extends ZENTRATestCase
{
    public static function rawValueProvider(): iterable
    {
        ...
        yield [
            'value'           => 'Zentra\Dashboard\Dashboard',
            'sanitized_value' => 'Zentra\Dashboard\Dashboard',
        ];
        yield [
            'value'           => ['itemtype' => 'Zentra\Dashboard\Dashboard'],
            'sanitized_value' => ['itemtype' => 'Zentra\Dashboard\Dashboard'],
        ];

        // callable syntax should not be sanitized
        yield [
            'value'           => 'Zentra\Socket:update',
            'sanitized_value' => 'Zentra\Socket:update',
        ];
        yield [
            'value'           => 'Zentra\Socket:update\' OR 1 = 1', // invalid syntax, should be sanitized
            'sanitized_value' => 'Zentra\\\Socket:update\\\' OR 1 = 1',
        ];
        yield [
            'value'             => "<strong>text with slashable chars ' \n \"</strong>",
            'sanitized_value'   => "&#60;strong&#62;text with slashable chars ' \n \"&#60;/strong&#62;",
...
TXT;
    ...
    public static function isNsClassOrCallableIdentifierProvider(): iterable
    {
        ...
        yield [
            'value'    => 'Zentra\Dashboard\Dashboard$1',
