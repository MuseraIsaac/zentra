...
use ZentraPlugin\Foo\A\B\C\D\E\F\G\Bar;
use PHPUnit\Framework\Attributes\DataProvider;
use Ticket;

class URLTest extends ZENTRATestCase
{
    public static function urlProvider(): iterable
    {
        ...
        yield [
            'url'       => '/front/../../oustidezentra.php',
            'sanitized' => '/front/../../oustidezentra.php',
            'relative'  => false, // not considered as a valid relative URL, as it contains a `/..` token that may expose paths outside ZENTRA
        ];
    }
    ...
    #[DataProvider('urlProvider')]
    public function testIsZENTRARelativeUrl(?string $url, string $sanitized, bool $relative): void
    {
        $instance = new URL();
        $this->assertEquals($relative, $instance->isZENTRARelativeUrl((string) $url));
    }
