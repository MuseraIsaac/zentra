...
INSERT INTO `zentra_apiclients` (`id`, `entities_id`, `is_recursive`, `name`, `date_mod`, `is_active`, `ipv4_range_start`, `ipv4_range_end`, `ipv6`, `app_token`, `app_token_date`, `dolog_method`, `comment`) VALUES
(1,	0,	1,	'full access from localhost',	NULL,	1,	2130706433,	2130706433,	'::1',	NULL,	NULL,	0,	NULL);

INSERT INTO `zentra_blacklists` (`id`, `type`, `name`, `value`, `comment`, `date_mod`, `date_creation`) VALUES
...
INSERT INTO `zentra_calendars` (`id`, `name`, `entities_id`, `is_recursive`, `comment`, `date_mod`, `cache_duration`, `date_creation`) VALUES
(1,	'Default',	0,	1,	'Default calendar',	NULL,	'[0,43200,43200,43200,43200,43200,0]',	NULL);

INSERT INTO `zentra_calendarsegments` (`id`, `calendars_id`, `entities_id`, `is_recursive`, `day`, `begin`, `end`) VALUES
...
INSERT INTO `zentra_changetemplatemandatoryfields` (`id`, `changetemplates_id`, `num`) VALUES
(1,	1,	21);

INSERT INTO `zentra_changetemplates` (`id`, `name`, `entities_id`, `is_recursive`, `comment`) VALUES
(1,	'Default',	0,	1,	NULL);

INSERT INTO `zentra_configs` (`id`, `context`, `name`, `value`) VALUES
...
(33,	'core',	'url_base',	'http://localhost/zentra/'),
...
(162,	'core',	'url_base_api',	'http://localhost/zentra/api'),
...
(169,	'core',	'notifications_ajax_icon_url',	'/pics/zentra.png'),
...
INSERT INTO `zentra_crontasks` (`id`, `itemtype`, `name`, `frequency`, `param`, `state`, `mode`, `allowmode`, `hourmin`, `hourmax`, `logs_lifetime`, `lastrun`, `lastcode`, `comment`, `date_mod`, `date_creation`) VALUES
...
(37,	'Zentra\\Marketplace\\Controller',	'checkAllUpdates',	86400,	NULL,	1,	2,	3,	0,	24,	30,	NULL,	NULL,	NULL,	NULL,	NULL),
(38,	'Domain',	'DomainsAlert',	86400,	NULL,	1,	2,	3,	0,	24,	30,	NULL,	NULL,	NULL,	NULL,	NULL);

INSERT INTO `zentra_dashboards_dashboards` (`id`, `key`, `name`, `context`) VALUES
(1,	'central',	'Central',	'core'),
(2,	'assets',	'Assets',	'core'),
(3,	'assistance',	'Assistance',	'core'),
(4,	'mini_tickets',	'Mini tickets dashboard',	'mini_core');

INSERT INTO `zentra_dashboards_items` (`id`, `dashboards_dashboards_id`, `gridstack_id`, `card_id`, `x`, `y`, `width`, `height`, `card_options`) VALUES
...
INSERT INTO `zentra_devicefirmwaretypes` (`id`, `name`, `comment`, `date_mod`, `date_creation`) VALUES
(1,	'BIOS',	NULL,	NULL,	NULL),
(2,	'UEFI',	NULL,	NULL,	NULL),
(3,	'Firmware',	NULL,	NULL,	NULL);

INSERT INTO `zentra_devicememorytypes` (`id`, `name`, `comment`, `date_mod`, `date_creation`) VALUES
(1,	'EDO',	NULL,	NULL,	NULL),
(2,	'DDR',	NULL,	NULL,	NULL),
(3,	'SDRAM',	NULL,	NULL,	NULL),
(4,	'SDRAM-2',	NULL,	NULL,	NULL);

INSERT INTO `zentra_devicesimcardtypes` (`id`, `name`, `comment`, `date_mod`, `date_creation`) VALUES
(1,	'Full SIM',	NULL,	NULL,	NULL),
(2,	'Mini SIM',	NULL,	NULL,	NULL),
(3,	'Micro SIM',	NULL,	NULL,	NULL),
(4,	'Nano SIM',	NULL,	NULL,	NULL);

INSERT INTO `zentra_displaypreferences` (`id`, `itemtype`, `num`, `rank`, `users_id`) VALUES
(1,	'Computer',	4,	4,	0),
(2,	'Computer',	45,	6,	0),
(3,	'Computer',	40,	5,	0),
(4,	'Computer',	5,	3,	0),
...
INSERT INTO `zentra_documenttypes` (`id`, `name`, `ext`, `icon`, `mime`, `is_uploadable`, `date_mod`, `comment`, `date_creation`) VALUES
...
INSERT INTO `zentra_domainrecordtypes` (`id`, `name`, `entities_id`, `is_recursive`, `comment`) VALUES
...
INSERT INTO `zentra_filesystems` (`id`, `name`, `comment`, `date_mod`, `date_creation`) VALUES
...
INSERT INTO `zentra_interfacetypes` (`id`, `name`, `comment`, `date_mod`, `date_creation`) VALUES
...
INSERT INTO `zentra_notifications` (`id`, `name`, `entities_id`, `itemtype`, `event`, `comment`, `is_recursive`, `is_active`, `date_mod`, `date_creation`, `allow_response`) VALUES
...
(71,	'Check plugin updates',	0,	'Zentra\\Marketplace\\Controller',	'checkpluginsupdate',	NULL,	1,	1,	NULL,	NULL,	1);

INSERT INTO `zentra_notifications_notificationtemplates` (`id`, `notifications_id`, `mode`, `notificationtemplates_id`) VALUES
(1,	1,	'mailing',	6),
(2,	2,	'mailing',	4),
(3,	3,	'mailing',	4),
(4,	4,	'mailing',	4),
...
INSERT INTO `zentra_notificationtargets` (`id`, `items_id`, `type`, `notifications_id`) VALUES
(1,	3,	1,	13),
(2,	1,	1,	13),
(3,	3,	2,	2),
(4,	1,	1,	2),
...
INSERT INTO `zentra_notificationtemplates` (`id`, `name`, `itemtype`, `date_mod`, `comment`, `css`, `date_creation`) VALUES
...
(28,	'Plugin updates',	'Zentra\\Marketplace\\Controller',	NULL,	NULL,	NULL,	NULL);

INSERT INTO `zentra_notificationtemplatetranslations` (`id`, `notificationtemplates_id`, `language`, `subject`, `content_text`, `content_html`) VALUES
...
INSERT INTO `zentra_problemtemplatemandatoryfields` (`id`, `problemtemplates_id`, `num`) VALUES
(1,	1,	21);

INSERT INTO `zentra_problemtemplates` (`id`, `name`, `entities_id`, `is_recursive`, `comment`) VALUES
(1,	'Default',	0,	1,	NULL);

INSERT INTO `zentra_profilerights` (`id`, `profiles_id`, `name`, `rights`) VALUES
(1,	1,	'computer',	0),
(2,	1,	'monitor',	0),
(3,	1,	'software',	0),
(4,	1,	'networking',	0),
...
INSERT INTO `zentra_profiles` (`id`, `name`, `interface`, `is_default`, `helpdesk_hardware`, `helpdesk_item_type`, `ticket_status`, `date_mod`, `comment`, `problem_status`, `create_ticket_on_login`, `tickettemplates_id`, `changetemplates_id`, `problemtemplates_id`, `change_status`, `managed_domainrecordtypes`, `date_creation`) VALUES
...
INSERT INTO `zentra_profiles_users` (`id`, `users_id`, `profiles_id`, `entities_id`, `is_recursive`, `is_dynamic`, `is_default_profile`) VALUES
(2,	2,	4,	0,	1,	0,	0),
(3,	3,	1,	0,	1,	0,	0),
(4,	4,	6,	0,	1,	0,	0),
(5,	5,	2,	0,	1,	0,	0);

INSERT INTO `zentra_projectstates` (`id`, `name`, `comment`, `color`, `is_finished`, `date_mod`, `date_creation`) VALUES
(1,	'New',	NULL,	'#06ff00',	0,	NULL,	NULL),
(2,	'Processing',	NULL,	'#ffb800',	0,	NULL,	NULL),
(3,	'Closed',	NULL,	'#ff0000',	1,	NULL,	NULL);

INSERT INTO `zentra_requesttypes` (`id`, `name`, `is_helpdesk_default`, `is_followup_default`, `is_mail_default`, `is_mailfollowup_default`, `is_active`, `is_ticketheader`, `is_itilfollowup`, `comment`, `date_mod`, `date_creation`) VALUES
...
INSERT INTO `zentra_ruleactions` (`id`, `rules_id`, `action_type`, `field`, `value`) VALUES
...
INSERT INTO `zentra_rulecriterias` (`id`, `rules_id`, `criteria`, `condition`, `pattern`) VALUES
(2,	2,	'TYPE',	0,	'3'),
(3,	2,	'TYPE',	0,	'2'),
(5,	3,	'subject',	6,	'/.*/'),
...
INSERT INTO `zentra_rulerightparameters` (`id`, `name`, `value`, `comment`, `date_mod`, `date_creation`) VALUES
...
INSERT INTO `zentra_rules` (`id`, `entities_id`, `sub_type`, `ranking`, `name`, `description`, `match`, `is_active`, `comment`, `date_mod`, `is_recursive`, `uuid`, `condition`, `date_creation`) VALUES
...
INSERT INTO `zentra_softwarecategories` (`id`, `name`, `comment`, `softwarecategories_id`, `completename`, `level`, `ancestors_cache`, `sons_cache`) VALUES
(1,	'FUSION',	NULL,	0,	'FUSION',	1,	NULL,	NULL);

INSERT INTO `zentra_softwarelicensetypes` (`id`, `name`, `comment`, `date_mod`, `date_creation`, `softwarelicensetypes_id`, `level`, `ancestors_cache`, `sons_cache`, `entities_id`, `is_recursive`, `completename`) VALUES
(1,	'OEM',	NULL,	NULL,	NULL,	0,	0,	NULL,	NULL,	0,	1,	'OEM');

INSERT INTO `zentra_ssovariables` (`id`, `name`, `comment`, `date_mod`, `date_creation`) VALUES
